...
class Inflectible
{
    ...
    public static function getSingular(): iterable
    {
        ...
        yield new Transformation(
            new Pattern('(buffal|her|potat|tomat|volcan)oes$'),
            '\1o'
        );
        yield new Transformation(
            new Pattern(
        ...
        yield new Transformation(
            new Pattern('(analys|ax|cris|test|thes)es$'),
            '\1is'
        );
        ...
        yield new Transformation(
            new Pattern(
                '(analy|diagno|^ba|(p)arenthe|(p)rogno|(s)ynop|(t)he)ses$'
            ),
            '\1\2sis'
        );
    ...
    public static function getPlural(): iterable
    {
        ...
        yield new Transformation(
            new Pattern('(matr|vert|ind)(ix|ex)$'),
            '\1ices'
        );
        ...
        yield new Transformation(
            new Pattern('(buffal|her|potat|tomat|volcan)o$'),
            '\1\2oes'
        );
        yield new Transformation(
            new Pattern(
        ...
        yield new Transformation(
            new Pattern('(analys|ax|cris|test|thes)is$'),
            '\1es'
        );
    ...
    public static function getIrregular(): iterable
    {
        ...
        yield new Substitution(
            new Word('hippopotamus'),
            new Word('hippopotami')
        );
