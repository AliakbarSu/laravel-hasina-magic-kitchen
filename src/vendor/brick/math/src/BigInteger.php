...
final class BigInteger extends BigNumber
{
    ...
    public static function fromBase(string $number, int $base): BigInteger
    {
        ...
        if ($base < 2 || $base > 36) {
            throw new \InvalidArgumentException(
                \sprintf('Base %d is not in range 2 to 36.', $base)
            );
        }
     ...
     * @psalm-pure
     */
    public static function fromArbitraryBase(
        string $number,
        string $alphabet
    ): BigInteger {
        if ($number === '') {
        ...
        $number = Calculator::get()->fromArbitraryBase(
            $number,
            $alphabet,
            $base
        );
    ...
    public static function fromBytes(
        ...
        if ($value === '') {
            throw new NumberFormatException(
                'The byte string must not be empty.'
            );
        }
    ...
    public static function randomBits(
        ...
        if ($numBits < 0) {
            throw new \InvalidArgumentException(
                'The number of bits cannot be negative.'
            );
        }
    ...
    public static function gcdMultiple(
        BigInteger $a,
        BigInteger ...$n
    ): BigInteger {
        $result = $a;
    ...
    public function dividedBy(
        ...
        $result = Calculator::get()->divRound(
            $this->value,
            $that->value,
            $roundingMode
        );
    ...
    public function quotientAndRemainder(
        ...
        [$quotient, $remainder] = Calculator::get()->divQR(
            $this->value,
            $that->value
        );
    ...
    public function modInverse(BigInteger $m): BigInteger
    {
        ...
        if ($value === null) {
            throw new MathException(
                'Unable to compute the modInverse for the given modulus.'
            );
        }
    ...
    public function modPow(
        BigNumber|int|float|string $exp,
        BigNumber|int|float|string $mod
    ): BigInteger {
        ...
        if ($this->isNegative() || $exp->isNegative() || $mod->isNegative()) {
            throw new NegativeNumberException(
                'The operands cannot be negative.'
            );
        }
    ...
    public function and(BigNumber|int|float|string $that): BigInteger
    {
        ...
        return new BigInteger(
            Calculator::get()->and($this->value, $that->value)
        );
    }
    ...
    public function or(BigNumber|int|float|string $that): BigInteger
    {
        ...
        return new BigInteger(
            Calculator::get()->or($this->value, $that->value)
        );
    }
    ...
    public function xor(BigNumber|int|float|string $that): BigInteger
    {
        ...
        return new BigInteger(
            Calculator::get()->xor($this->value, $that->value)
        );
    }
    ...
    public function testBit(int $n): bool
    {
        if ($n < 0) {
            throw new \InvalidArgumentException(
                'The bit to test cannot be negative.'
            );
        }
    ...
    public function toBase(int $base): string
    {
        ...
        if ($base < 2 || $base > 36) {
            throw new \InvalidArgumentException(
                \sprintf('Base %d is out of range [2, 36]', $base)
            );
        }
    ...
    public function toArbitraryBase(string $alphabet): string
    {
        ...
        if ($this->value[0] === '-') {
            throw new NegativeNumberException(
                __FUNCTION__ . '() does not support negative numbers.'
            );
        }

        return Calculator::get()->toArbitraryBase(
            $this->value,
            $alphabet,
            $base
        );
    ...
    public function __unserialize(array $data): void
    {
        if (isset($this->value)) {
            throw new \LogicException(
                '__unserialize() is an internal function, it must not be called directly.'
            );
        }
    ...
    public function unserialize($value): void
    {
        if (isset($this->value)) {
            throw new \LogicException(
                'unserialize() is an internal function, it must not be called directly.'
            );
        }
