...
abstract class BigNumber implements \Serializable, \JsonSerializable
{
    ...
    public static function of(BigNumber|int|float|string $value): BigNumber
    {
        ...
        $getMatch = static fn(string $value): ?string => ($matches[$value] ??
            '') !==
        ''
            ? $matches[$value]
            : null;
     ...
     * @psalm-pure
     */
    protected function newBigRational(
    ...
    public static function min(BigNumber|int|float|string ...$values): static
    {
        ...
        if ($min === null) {
            throw new \InvalidArgumentException(
                __METHOD__ . '() expects at least one value.'
            );
        }
     ...
     */
    abstract public function toScale(
        int $scale,
