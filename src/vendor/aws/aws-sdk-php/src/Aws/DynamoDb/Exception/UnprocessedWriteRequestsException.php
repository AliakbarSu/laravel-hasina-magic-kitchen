 ...
 */
class UnprocessedWriteRequestsException extends RuntimeException implements
    \IteratorAggregate,
    \Countable
{
    /**
     ...
     * {@inheritdoc}
     */
    public function __construct(array $unprocessedItems = [])
    {
        parent::__construct(
            'There were unprocessed items in the DynamoDb ' .
