...
trait RequestAssertionsTrait
{
     ...
     */
    protected static function assertRequestGet(
        RequestInterface $request,
        $message = 'HTTP method should be GET'
    ) {
     ...
     * @param string           $message
     */
    protected static function assertRequestPost(
        RequestInterface $request,
        $message = 'HTTP method should be POST'
    ) {
     ...
     * @param string           $message
     */
    protected static function assertRequestDelete(
        RequestInterface $request,
        $message = 'HTTP method should be DELETE'
    ) {
     ...
     * @param string           $message
     */
    protected static function assertRequestPut(
        RequestInterface $request,
        $message = 'HTTP method should be PUT'
    ) {
     ...
     * @param string           $message
     */
    protected static function assertRequestFields(
        RequestInterface $request,
        $fields = null,
        $message = ''
    ) {
     ...
     * @param string           $message
     */
    protected static function assertRequestUrl(
        RequestInterface $request,
        $path,
        $message = ''
    ) {
     ...
     * @param string           $message
     */
    protected static function assertRequestQueryStringSubset(
        RequestInterface $request,
        $fields = null,
        $message = ''
    ) {
        self::assertSubset(
            ...
            $message ?:
            'The expected fields and values were not found in the request query string'
        );
    }
     ...
     * @param string           $message
     */
    protected static function assertRequestBodySubset(
        RequestInterface $request,
        $fields = null,
        $message = ''
    ) {
        self::assertSubset(
            ...
            $message ?:
            'The expected fields and values were not found in the request body'
        );
    }
     ...
     * @param string           $message
     */
    protected static function assertRequestJsonBodySubset(
        RequestInterface $request,
        $fields = null,
        $message = ''
    ) {
     ...
     * @param string           $message
     */
    protected static function assertRequestHeaderSubset(
        RequestInterface $request,
        $fields = null,
        $message = ''
    ) {
        self::assertSubset(
            ...
            $request->getHeaders(),
            $message ?:
            'The expected fields and values were not found in the request header'
        );
    }
}
