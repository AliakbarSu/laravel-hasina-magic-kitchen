...
final class TagTest extends IntegrationTestCase
{
    ...
    public static function setUpBeforeClass()
    {
        ...
        self::$TAG_TO_ADD_TO_IMAGE =
            'upload_tag_add_tag_test_' . self::$UNIQUE_TEST_TAG;
        self::$TAG_TO_REPLACE_ALL_TAGS =
            'upload_tag_replace_all_tags_' . self::$UNIQUE_TEST_TAG;
        self::$TAG_TO_REMOVE =
            'upload_tag_remove_tag_' . self::$UNIQUE_TEST_TAG;
    ...
    {
        $result = self::$uploadApi->addTag(self::$TAG_TO_ADD_TO_IMAGE, [
    ...
    {
        $result = self::$uploadApi->removeTag(self::$TAG_TO_REMOVE, [
            self::getTestAssetPublicId(self::ADD_AND_DELETE_TAG),
        ]);
    ...
    {
        $result = self::$uploadApi->removeAllTags([
    ...
    {
        $result = self::$uploadApi->replaceTag(self::$UNIQUE_TEST_TAG, [
