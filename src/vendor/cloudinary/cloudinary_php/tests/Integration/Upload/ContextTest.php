...
final class ContextTest extends IntegrationTestCase
{
    ...
    public static function setUpBeforeClass()
    {
        ...
        self::createTestAssets([
            ...
            self::REMOVING_ALL_CONTEXT_1 => [
                'options' => ['context' => self::CONTEXT_DATA],
            ],
            self::REMOVING_ALL_CONTEXT_2 => [
                'options' => ['context' => self::CONTEXT_DATA],
            ],
            self::REMOVING_ALL_CONTEXT_3 => [
                'options' => ['context' => self::CONTEXT_DATA],
            ],
        ]);
    }
    ...
    {
        $result = self::$uploadApi->addContext(self::CONTEXT_DATA, [
