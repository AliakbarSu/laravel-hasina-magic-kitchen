...
class MetadataFieldsTest extends IntegrationTestCase
{
    ...
    public static function setUpBeforeClass()
    {
        ...
        self::$METADATA_FIELDS[] = self::$EXTERNAL_ID_GENERAL =
            'metadata_external_id_general_' . $id;
        self::$METADATA_FIELDS[] = self::$EXTERNAL_ID_DATE =
            'metadata_external_id_date_' . $id;
        self::$METADATA_FIELDS[] = self::$EXTERNAL_ID_ENUM =
            'metadata_external_id_enum_' . $id;
        self::$METADATA_FIELDS[] = self::$EXTERNAL_ID_SET =
            'metadata_external_id_set_' . $id;
        self::$METADATA_FIELDS[] = self::$EXTERNAL_ID_SET_2 =
            'metadata_external_id_set_2_' . $id;
        self::$METADATA_FIELDS[] = self::$EXTERNAL_ID_SET_3 =
            'metadata_external_id_set_3_' . $id;
        self::$METADATA_FIELDS[] = self::$EXTERNAL_ID_DELETE =
            'metadata_deletion_test_' . $id;
        self::$METADATA_FIELDS[] = self::$EXTERNAL_ID_DATE_VALIDATION =
            'metadata_date_validation_' . $id;
        self::$METADATA_FIELDS[] = self::$EXTERNAL_ID_DATE_VALIDATION_2 =
            'metadata_date_validation_2_' . $id;
        self::$METADATA_FIELDS[] = self::$EXTERNAL_ID_INT_VALIDATION =
            'metadata_integer_validation_' . $id;
        self::$METADATA_FIELDS[] = self::$EXTERNAL_ID_INT_VALIDATION_2 =
            'metadata_integer_validation_2_' . $id;
        // Sample datasource data
        self::$DATASOURCE_ENTRY_EXTERNAL_ID =
            'metadata_datasource_entry_external_id' . $id;
        ...
        $stringMetadataField = new StringMetadataField(
        ...
        $enumMetadataField = new EnumMetadataField(
        ...
        $setMetadataField = new SetMetadataField(
     ...
     */
    private static function assertMetadataField(
        $metadataField,
        $type = null,
        $values = []
    ) {
        ...
        if ($type) {
            ...
            self::assertContains($metadataField['type'], [
        ...
        if (
            in_array(
                $metadataField['type'],
                [MetadataFieldType::ENUM, MetadataFieldType::SET],
                true
            )
        ) {
    ...
    private static function assertMetadataFieldDataSource($dataSource)
    {
        ...
        if (!empty($dataSource['values'])) {
            ...
            if (!empty($dataSource['values'][0]['state'])) {
                self::assertContains($dataSource['values'][0]['state'], [
                    'active',
                    'inactive',
                ]);
            }
    ...
    {
        $result = self::$adminApi->metadataFieldByFieldId(
            self::$EXTERNAL_ID_GENERAL
        );

        self::assertMetadataField($result, MetadataFieldType::STRING, [
    ...
    public function testCreateDateMetadataField()
    {
        ...
        self::assertMetadataField($result, MetadataFieldType::DATE, [
    ...
    public function testCreateSetMetadataField()
    {
        ...
        $setMetadataField->setDefaultValue([
            self::$DATASOURCE_ENTRY_EXTERNAL_ID,
            'v4',
        ]);
        ...
        self::assertMetadataField($result, MetadataFieldType::SET, [
    ...
    {
        $newLabel =
            'update_metadata_test_new_label_' . self::$EXTERNAL_ID_GENERAL;
        $newDefaultValue =
            'update_metadata_test_new_default_value_' .
            self::$EXTERNAL_ID_GENERAL;
        ...
        $result = self::$adminApi->updateMetadataField(
            self::$EXTERNAL_ID_GENERAL,
            $stringMetadataField
        );
    ...
    public function testUpdateMetadataFieldDataSource()
    {
        ...
        self::assertEquals(
            self::$DATASOURCE_SINGLE[0]['value'],
    ...
    public function testDeleteMetadataFieldDoesNotReleaseExternalId()
    {
        ...
        $result = self::$adminApi->deleteMetadataField(
            self::$EXTERNAL_ID_DELETE
        );
        ...
        $this->expectExceptionMessage(
            'external id ' . self::$EXTERNAL_ID_DELETE . ' already exists'
        );
    ...
    public function testDeleteMetadataFieldDataSource()
    {
        ...
        self::assertMetadataFieldDataSource($result);
        self::assertCount(
            count(self::$DATASOURCE_MULTIPLE) - 1,
            $result['values']
        );
    ...
    public function testDateFieldDefaultValueValidation()
    {
        ...
        $dateMetadataField = new DateMetadataField(
            self::$EXTERNAL_ID_DATE_VALIDATION
        );
        ...
        $dateMetadataField = new DateMetadataField(
            self::$EXTERNAL_ID_DATE_VALIDATION_2
        );
    ...
    public function testIntegerFieldValidation()
    {
        ...
        $intMetadataField = new IntMetadataField(
            self::$EXTERNAL_ID_INT_VALIDATION
        );
        ...
        self::assertMetadataField($result, MetadataFieldType::INTEGER, [
        ...
        // Test entering a metadata field with integer validation and a valid default value
        $intMetadataField = new IntMetadataField(
            self::$EXTERNAL_ID_INT_VALIDATION_2
        );
    ...
    public function testReorderMetadataFieldDatasource()
    {
        ...
        $result = self::$adminApi->reorderMetadataFieldDatasource(
            self::$EXTERNAL_ID_SET_3,
            'value',
            'asc'
        );
        ...
        self::assertEquals(
            self::$DATASOURCE_MULTIPLE[0]['value'],
            $result['values'][0]['value']
        );
        ...
        self::assertEquals(
            self::$DATASOURCE_MULTIPLE[2]['value'],
            $result['values'][0]['value']
        );
    }
}
