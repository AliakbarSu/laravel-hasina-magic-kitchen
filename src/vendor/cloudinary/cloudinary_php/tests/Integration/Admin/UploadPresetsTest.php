...
final class UploadPresetsTest extends IntegrationTestCase
{
    ...
    public static function setUpBeforeClass()
    {
        ...
        self::$UPLOAD_PRESETS[] = self::$UPLOAD_PRESET_WITH_NAME =
            'upload_preset_with_name_' . $id;
        self::$UPLOAD_PRESETS[] = self::$UPLOAD_PRESET_WITH_PARAMETERS =
            'upload_preset_with_parameters_' . $id;
        self::$UPLOAD_PRESETS[] = self::$UPLOAD_PRESET_UPDATE =
            'upload_preset_update_' . $id;
    ...
    {
        $uploadPreset = self::$adminApi->uploadPreset(
    ...
    public function testCreateUploadPresetWithNoName()
    {
        ...
        self::assertValidUploadPreset($uploadPreset, [
            'name' => $result['name'],
            'unsigned' => false,
        ]);
    }
    ...
    public function testCreateUploadPresetWithParameters()
    {
        ...
        $uploadPreset = self::$adminApi->uploadPreset(
            self::$UPLOAD_PRESET_WITH_PARAMETERS
        );
