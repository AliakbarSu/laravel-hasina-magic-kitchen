...
final class TransformationsTest extends IntegrationTestCase
{
    ...
    public static function setUpBeforeClass()
    {
        ...
        self::$TRANSFORMATIONS[] = self::$TRANSFORMATION_NAME =
            'transformation_name_' . $id;
        self::$TRANSFORMATIONS[] = self::$TRANSFORMATION_NAME_STRING =
            'transformation_name_string_' . $id;
        self::$TRANSFORMATIONS[] = self::$TRANSFORMATION_NAME_PARAMETERS =
            'transformation_name_parameters_' . $id;
        self::$TRANSFORMATIONS[] = self::$TRANSFORMATION_NAME_DELETE =
            'transformation_name_delete_' . $id;
        ...
        self::$TRANSFORMATIONS[] = self::$TRANSFORMATION_PARAMETER_AS_STRING =
            '' .
            'c_' .
            self::$TRANSFORMATION_PARAMETER_AS_ARRAY['crop'] .
            ',' .
            'h_' .
            self::$TRANSFORMATION_PARAMETER_AS_ARRAY['height'] .
            ',' .
            'w_' .
            self::$TRANSFORMATION_PARAMETER_AS_ARRAY['width'];
    ...
    public function testGetDetailTransformationByName()
    {
        ...
        self::assertValidTransformation(
            ...
            [
                ...
                'named' => true,
                'name' =>
                    self::TRANSFORMATION_NAME_PREFIX .
                    self::$TRANSFORMATION_NAME,
            ],
            self::$TRANSFORMATION_PARAMETER_AS_ARRAY
        );
    ...
    public function testCreateNamedTransformationByString()
    {
        ...
        $result = self::$adminApi->transformation(
            self::$TRANSFORMATION_NAME_STRING
        );
    ...
    public function testUpdateNamedTransformation()
    {
        ...
        self::assertValidTransformation(
            $result,
            [],
            self::TRANSFORMATION_PARAMETER_UPDATE
        );
    }
    ...
    public function testDeleteTransformationByName()
    {
        ...
        self::assertValidTransformation($result, [
            'allowed_for_strict' => true,
            'used' => false,
            'named' => true,
            'name' =>
        ...
        $result = self::$adminApi->deleteTransformation(
            self::$TRANSFORMATION_NAME_DELETE
        );
