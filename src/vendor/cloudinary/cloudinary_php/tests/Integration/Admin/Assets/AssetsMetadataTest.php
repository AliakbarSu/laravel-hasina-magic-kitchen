...
final class AssetsMetadataTest extends IntegrationTestCase
{
    ...
    public static function setUpBeforeClass()
    {
        ...
        self::$UNIQUE_TEST_METADATA_EXTERNAL_ID =
            self::CLASS_PREFIX .
            'metadata_external_id_' .
            self::$UNIQUE_TEST_ID;
        self::$UNIQUE_TEST_METADATA_DEFAULT_VALUE =
            self::CLASS_PREFIX .
            'metadata_default_value_' .
            self::$UNIQUE_TEST_ID;

        self::$UNIQUE_TEST_METADATA = new StringMetadataField(
            self::$UNIQUE_TEST_METADATA_EXTERNAL_ID
        );
        self::$UNIQUE_TEST_METADATA->setExternalId(
            self::$UNIQUE_TEST_METADATA_EXTERNAL_ID
        );
        self::$UNIQUE_TEST_METADATA->setDefaultValue(
            self::$UNIQUE_TEST_METADATA_DEFAULT_VALUE
        );
