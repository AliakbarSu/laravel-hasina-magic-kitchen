...
final class RestoreAssetsTest extends IntegrationTestCase
{
    ...
    public static function setUpBeforeClass()
    {
        ...
        self::$UNIQUE_TEST_TAG_RESTORE =
            'asset_restore_' . self::$UNIQUE_TEST_TAG;
    ...
    public function testRestoreDeletedAssetsByPublicId()
    {
        ...
        self::assertEquals(
            AssetType::IMAGE,
            $result[self::getTestAssetPublicId(self::RESTORE_ASSET)][
                AssetType::KEY
            ]
        );
    ...
    public function testRestoreDifferentDeletedAssets()
    {
        ...
        self::assertEquals(
            $restoreResult[self::getTestAssetPublicId(self::BACKUP_ASSET_1)][
                'bytes'
            ],
            self::getTestAsset(self::BACKUP_ASSET_1)['bytes']
        );
        self::assertEquals(
            $restoreResult[self::getTestAssetPublicId(self::BACKUP_ASSET_2)][
                'bytes'
            ],
