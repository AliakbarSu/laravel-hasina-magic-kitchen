...
final class AssetTest extends IntegrationTestCase
{
    ...
    public static function setUpBeforeClass()
    {
        ...
        self::$UNIQUE_CONTEXT_KEY =
            'asset_context_key_' . self::$UNIQUE_TEST_ID;
        self::$UNIQUE_CONTEXT_VALUE =
            'asset_context_value_' . self::$UNIQUE_TEST_ID;
        self::$UNIQUE_CONTEXT = [
    ...
    {
        $result = self::$adminApi->assetByAssetId(
            self::getTestAssetAssetId(self::ASSET_IMAGE)
        );
    ...
    public function testGetFacebookImageDetails()
    {
        $this->markTestSkipped(
            'FIXME: Fetch facebook image before running this test'
        );

        $result = self::$adminApi->asset('sample', [
