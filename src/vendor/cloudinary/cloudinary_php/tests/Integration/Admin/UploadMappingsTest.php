...
final class UploadMappingsTest extends IntegrationTestCase
{
    ...
    public static function setUpBeforeClass()
    {
        ...
        self::$FOLDERS[] = self::$FOLDER_NAME =
            'upload_mapping_folder_name_' . self::$UNIQUE_TEST_ID;
        self::$FOLDERS[] = self::$FOLDER_NAME_CREATE =
            'upload_mapping_folder_name_create_' . self::$UNIQUE_TEST_ID;
        self::$FOLDERS[] = self::$FOLDER_NAME_UPDATE =
            'upload_mapping_folder_name_update_' . self::$UNIQUE_TEST_ID;
        self::$FOLDERS[] = self::$FOLDER_NAME_DELETE =
            'upload_mapping_folder_name_delete_' . self::$UNIQUE_TEST_ID;

        self::$adminApi->createUploadMapping(self::$FOLDER_NAME, [
    ...
    public function testGetUploadMappings()
    {
        ...
        self::assertArrayContainsArray($result['mappings'], [
    ...
    public function testGetDetailUploadMapping()
    {
        ...
        self::assertValidUploadMapping($uploadMapping, [
            'template' => self::TEMPLATE,
            'folder' => self::$FOLDER_NAME,
        ]);
    }
    ...
    public function testCreateUploadMapping()
    {
        ...
        $uploadMapping = self::$adminApi->uploadMapping(
            self::$FOLDER_NAME_CREATE
        );
    ...
    {
        self::$adminApi->createUploadMapping(self::$FOLDER_NAME_UPDATE, [
            'template' => self::TEMPLATE,
        ]);
    ...
    {
        self::$adminApi->createUploadMapping(self::$FOLDER_NAME_DELETE, [
            'template' => self::TEMPLATE,
        ]);

        $result = self::$adminApi->deleteUploadMapping(
            self::$FOLDER_NAME_DELETE
        );
