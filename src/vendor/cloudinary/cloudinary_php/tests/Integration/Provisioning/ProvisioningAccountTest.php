...
final class ProvisioningAccountTest extends ProvisioningIntegrationTestCase
{
    ...
    public static function setUpBeforeClass()
    {
        ...
        self::$SUB_ACCOUNT_ID_NON_EXISTENT =
            'sub_account_non_existent_' . self::$UNIQUE_TEST_ID;

        self::$USER_CREATE_NAME =
            'provisioning_user_name_create_' . self::$UNIQUE_TEST_ID;
        self::$USER_CREATE_EMAIL =
            'provisioning_user_create_' .
            self::$UNIQUE_TEST_ID .
            '@cloudinary.com';
        self::$USER_DELETE_NAME =
            'provisioning_user_name_delete_' . self::$UNIQUE_TEST_ID;
        self::$USER_DELETE_EMAIL =
            'provisioning_user_delete_' .
            self::$UNIQUE_TEST_ID .
            '@cloudinary.com';
        self::$USER_GET_NAME =
            self::$PREFIX .
        ...
        self::$USER_GROUP_CREATE_NAME =
            'provision_user_group_create_name_' . self::$UNIQUE_TEST_ID;
        self::$USER_GROUP_GET_NAME =
            'provision_user_group_get_name_' . self::$UNIQUE_TEST_ID;
        ...
        $userGroup = self::$accountApi->createUserGroup(
            self::$USER_GROUP_GET_NAME
        );
        ...
        self::$accountApi->addUserToGroup(
            self::$USER_GROUP_GET_ID,
            self::$USER_GET_ID
        );
    }
    ...
    {
        $result = self::$accountApi->users(null, [
            self::$USER_GET_ID,
            self::$USER_UPDATE_ID,
        ]);
    ...
    public function testGetUsersByNonExistentSubAccountId()
    {
        ...
        $this->expectExceptionMessage(
            'Cannot find sub account with id ' .
                self::$SUB_ACCOUNT_ID_NON_EXISTENT
        );

        self::$accountApi->users(
            true,
            [],
            null,
            self::$SUB_ACCOUNT_ID_NON_EXISTENT
    ...
    public function testGetUserById()
    {
        ...
        self::assertValidAccountUser($user, [
