...
final class ProvisioningUserGroupTest extends ProvisioningIntegrationTestCase
{
    ...
    public static function setUpBeforeClass()
    {
        ...
        self::$USER_GET_NAME =
            'provisioning_user_name_get_' . self::$UNIQUE_TEST_ID;
        self::$USER_GET_EMAIL =
        ...
        self::$USER_GROUP_DELETE_NAME =
            'provision_user_group_delete_name_' . self::$UNIQUE_TEST_ID;
        self::$USER_GROUP_GET_NAME =
            'provision_user_group_get_name_' . self::$UNIQUE_TEST_ID;
        self::$USER_GROUP_UPDATE_NAME =
            'provision_user_group_update_name_' . self::$UNIQUE_TEST_ID;
        self::$USER_GROUP_UPDATE_NEW_NAME =
            'new_' . self::$USER_GROUP_UPDATE_NAME;
    ...
    {
        $userGroup = self::$accountApi->updateUserGroup(
            self::$USER_GROUP_UPDATE_ID,
            self::$USER_GROUP_UPDATE_NEW_NAME
        );
    ...
    {
        $result = self::$accountApi->deleteUserGroup(
            self::$USER_GROUP_DELETE_ID
        );
    ...
    {
        $result = self::$accountApi->addUserToGroup(
            self::$USER_GROUP_UPDATE_ID,
            self::$USER_GET_ID
        );

        self::assertCount(1, $result['users']);
        self::assertValidUserGroupUsers($result['users'][0], [
            'id' => self::$USER_GET_ID,
    ...
    {
        $result = self::$accountApi->removeUserFromGroup(
            self::$USER_GROUP_UPDATE_ID,
            self::$USER_GET_ID
        );
