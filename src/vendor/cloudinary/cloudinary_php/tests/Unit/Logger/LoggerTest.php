...
final class LoggerTest extends UnitTestCase
{
    ...
    public function testHandlersConfiguration(
        ...
        if (!empty($expectContainClasses)) {
            foreach ($expectContainClasses as $expectedClass) {
                self::assertContainsInstancesOf(
                    $expectedClass,
                    $testLogger->getHandlers()
                );
            }
        }
    }
    ...
    public static function dataProvider()
    {
        return [
            ...
            [
                ...
                'expectedCount' => 1,
                'expectContainClasses' => [ErrorLogHandler::class],
            ],
            [
                'config' => [
                    'error_log' => true,
            ...
            [
                ...
                'expectedCount' => 1,
                'expectContainClasses' => [NullHandler::class],
            ],
            [
                'config' => [],
                'expectedCount' => 1,
    ...
    {
        $errorsCaught = [];
        $errorHandler = static function ($errNo, $errString) use (
            &$errorsCaught
        ) {
