...
class ConfigurationTest extends UnitTestCase
{
    ...
    public function testConfigToString()
    {
        ...
        self::assertStrEquals(
            $this->cloudinaryUrl .
                '/my_distribution?cloud[signature_algorithm]=sha256&url[cname]=my.domain.com',
            $config
        );
    }
    ...
    public function testConfigJsonSerialize()
    {
        $jsonConfig = json_encode(
            Configuration::fromCloudinaryUrl($this->cloudinaryUrl)
        );
