...
final class ApiUtilsTest extends UnitTestCase
{
    ...
    {
        self::assertEquals($result, ApiUtils::serializeHeaders($value));
    }
    ...
    {
        self::assertEquals($result, ApiUtils::serializeArrayOfArrays($value));
    }
    ...
    {
        self::assertEquals($result, ApiUtils::serializeContext($value));
    }
    ...
    public function dataProviderSignWithAlgorithmParameters()
    {
        return [
            ...
            [
                'value' => ['p1' => 'v1=v2*|}{ & !@#$%^&*()_;/.,?><\\/|_+a'],
                'result' =>
                    '9cdbdd04f587b41db72d66437f6dac2a379cd899c0cf3c3430925b1beca6052d',
     ...
     */
    public function testSignParametersWithExplicitSignatureAlgorithm(
        $value,
        $result,
        $signatureAlgorithm
    ) {
    ...
    public function testApiSignRequestWithGlobalConfig()
    {
        ...
        Configuration::instance()->cloud->apiSecret =
            'hdcixPpR2iKERPwqvH6sHdK9cyac';
        Configuration::instance()->cloud->signatureAlgorithm =
            Utils::ALGO_SHA256;
    ...
    public function testApiSignRequestWithExplicitConfig()
    {
        ...
        $config = new Configuration(
            'cloudinary://key:hdcixPpR2iKERPwqvH6sHdK9cyac@test123'
        );
