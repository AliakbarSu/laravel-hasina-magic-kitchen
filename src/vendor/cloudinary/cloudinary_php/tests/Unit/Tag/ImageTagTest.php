...
final class ImageTagTest extends ImageTagTestCase
{
    ...
    public function setUp()
    {
        ...
        $this->breakpointsConf->responsiveBreakpoints->minWidth =
            self::MIN_WIDTH;
        $this->breakpointsConf->responsiveBreakpoints->maxWidth =
            self::MAX_WIDTH;
        $this->breakpointsConf->responsiveBreakpoints->maxImages =
            self::MAX_IMAGES;
    ...
    {
        self::assertImageTag([$this->src], new ImageTag(self::IMAGE_NAME));
    }
    ...
    public function testImageTagFromParams()
    {
        self::assertStrEquals(
            ...
            ImageTag::fromParams(self::IMAGE_NAME, [
                'crop' => 'scale',
                'width' => 500,
                'secure' => true,
    ...
    {
        self::assertImageTag([$this->src], new ImageTag($this->src));
    }
    ...
    public function testImageTagCustomConfiguration()
    {
        ...
        self::assertImageTag(
            ...
            (new ImageTag(self::IMAGE_NAME))
                ->cloudName(self::CUSTOM_CLOUD_NAME)
                ->shorten()
        );
    }
    ...
    public function testImageTagTransformations()
    {
        self::assertImageTag(
            ...
            ImageTag::upload(self::IMAGE_NAME)->resize(
                Scale::scale(self::MAX_WIDTH)
            )
        );
    }
    ...
    public function testImageTagStaticBreakpointsLoggingWrongAttributes()
    {
        ...
        $message = null;
        $expectedExceptionMessage =
            'Either valid (minWidth, maxWidth, maxImages) or breakpointsmust be provided to ' .
