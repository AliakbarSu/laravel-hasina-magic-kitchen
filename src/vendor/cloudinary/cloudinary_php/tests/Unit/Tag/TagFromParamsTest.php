...
final class TagFromParamsTest extends ImageTagTestCase
{
    ...
    public function testImageTag()
    {
        ...
        self::assertStrEquals(
            "<img src='" .
                self::DEFAULT_UPLOAD_PATH .
                "c_fill,h_10,w_10/test.png' height='10' width='10'/>",
            $tag
        );
    }
    ...
    public function testClientHintsMetaTag()
    {
        ...
        self::assertStrEquals(
            ...
            $tags->item(0)->getAttribute('content')
        );
        self::assertStrEquals(
            'Accept-CH',
            $tags->item(0)->getAttribute('http-equiv')
        );
    }
    ...
    {
        $tag = ImageTag::fromParams("test's special < \"characters\" >", [
            'width' => 10,
            'height' => 10,
            'crop' => 'fill',
            'format' => 'png',
    ...
    public function testResponsiveWidth()
    {
        ...
        self::assertStrEquals(
            self::DEFAULT_UPLOAD_PATH .
                'c_crop,h_100,w_100/c_limit,w_auto/test',
            $result
        );
        ...
        self::assertStrEquals(
            self::DEFAULT_UPLOAD_PATH .
                'c_crop,h_100,w_100/c_pad,w_auto:breakpoints/test',
            $result
        );
    }
    ...
    public function testWidthAuto()
    {
        ...
        self::assertStrEquals(
            "<img class='cld-responsive' data-src='" .
                self::DEFAULT_UPLOAD_PATH .
                "c_limit,w_auto:breakpoints/hello.png'/>",
            $tag
        );
    ...
    public function sharedClientHints($options, $message = '')
    {
        ...
        $tag = ImageTag::fromParams(
            'sample.jpg',
            array_merge(['responsive' => true], $options)
        );
        self::assertStrEquals(
            "<img src='http://res.cloudinary.com/test/image/upload/c_scale,dpr_auto,w_auto/sample.jpg'/>",
            $tag,
    ...
    public function testClientHintsFalse()
    {
        ...
        $tag = ImageTag::fromParams('sample.jpg', [
            'width' => 'auto',
            'crop' => 'scale',
            'cloud_name' => 'test123',
            'client_hints' => false,
    ...
    public function testImageTagSrcset()
    {
        ...
        $tagWithBreakpoints = ImageTag::fromParams(
            self::$publicId,
            array_merge(self::$commonImageOptions, [
    ...
    public function testSupportSrcsetAttributeDefinedByMinWidthMaxWidthAndMaxImages()
    {
        ...
        $tagWithSizes = ImageTag::fromParams(
            self::$publicId,
            array_merge(self::$commonImageOptions, [
                'srcset' => array_merge(self::$commonSrcset, ['sizes' => true]),
            ])
        );
    ...
    public function testCreateATagWithCustomAttributesLegacyApproach()
    {
        $tagWithCustomLegacyAttribute = ImageTag::fromParams(
            self::$publicId,
            array_merge(self::$commonImageOptions, self::$customAttributes)
        );
        ...
        self::assertStrEquals(
            $expectedCustomAttributesTag,
            $tagWithCustomLegacyAttribute
        );
    }
    ...
    {
        $srcsetAttribute = [
            'srcset' => 'http://custom.srcset.attr/sample.jpg 100w',
        ];
        $tagWithCustomSrcsetAttribute = ImageTag::fromParams(
            self::$publicId,
            array_merge(self::$commonImageOptions, $srcsetAttribute)
        );
    ...
    public function testOverrideExistingAttributesWithSpecifiedByCustomOnes()
    {
        ...
        self::assertStrEquals(
            $expectedOverridenAttributesTag,
            $tagWithCustomOverridenAttribute
        );
    }
    ...
    public function testSpriteTag()
    {
        self::assertStrEquals(
            "<link href='" .
                self::DEFAULT_PATH .
                "/image/sprite/c_fill,h_10,w_10/mytag.css' " .
                "rel='stylesheet' type='text/css'/>",
            SpriteTag::fromParams('mytag', [
                'crop' => 'fill',
                'width' => 10,
                'height' => 10,
            ])
    ...
    public function testVideoTagFetch()
    {
        ...
        self::assertStrEquals(
            "<video poster='{$prefixUrl}f_jpg/$videoUrl'>" .
                ...
                '</video>',
            VideoTag::fromParams($videoUrl, [
                DeliveryType::KEY => DeliveryType::FETCH,
            ])
        );
    }
    ...
    public function testVideoTagWithTransformation()
    {
        ...
        $options['width'] = 250;
        $expectedUrl =
            self::VIDEO_UPLOAD_PATH . 'ac_acc,so_3,vc_h264,w_250/movie';
        self::assertStrEquals(
        ...
        $expectedUrl =
            self::VIDEO_UPLOAD_PATH . 'ac_acc,c_fit,so_3,vc_h264,w_250/movie';
        $options['crop'] = 'fit';
        self::assertStrEquals(
            "<video poster='$expectedUrl.jpg'>" .
                "<source src='$expectedUrl.webm' type='video/webm'>" .
    ...
    public function testVideoTagWithFallback()
    {
        ...
        self::assertStrEquals(
            "<video poster='$expectedUrl.jpg' src='$expectedUrl.mp4'>" .
                $fallback .
                '</video>',
            VideoTag::fromParams('movie', [
    ...
    public function testVideoTagWithPoster()
    {
        ...
        self::assertStrEquals(
            "<video poster='$expectedPosterUrl' src='$expectedUrl.mp4'></video>",
            VideoTag::fromParams('movie', [
                'poster' => ['gravity' => 'north'],
                'source_types' => 'mp4',
            ])
        );

        $expectedPosterUrl =
            self::DEFAULT_UPLOAD_PATH . 'g_north/my_poster.jpg';
        self::assertStrEquals(
            "<video poster='$expectedPosterUrl' src='$expectedUrl.mp4'></video>",
            VideoTag::fromParams('movie', [
                'poster' => [
    ...
    public function testVideoTagSpecialCharactersEncoding()
    {
        $expectedUrl =
            ...
            'movie%27s%20id%21%40%23%24%25%5E%26%2A%28';

        self::assertStrEquals(
            "<video poster='$expectedUrl.jpg' src='$expectedUrl.mp4'></video>",
            VideoTag::fromParams("movie's id!@#$%^&*(", [
                'source_types' => 'mp4',
            ])
        );
    }
    ...
    public function testVideoTagDefaultSources()
    {
        ...
        self::assertStrEquals(
            "<video poster='" .
                sprintf($expectedUrl, '', 'jpg') .
                "'>" .
                "<source src='" .
                sprintf($expectedUrl, 'vc_h265/', 'mp4') .
                "' type='video/mp4; codecs=hev1'>" .
                "<source src='" .
                sprintf($expectedUrl, 'vc_vp9/', 'webm') .
                "' type='video/webm; codecs=vp9'>" .
                "<source src='" .
                sprintf($expectedUrl, 'vc_auto/', 'mp4') .
                "' type='video/mp4'>" .
                "<source src='" .
                sprintf($expectedUrl, 'vc_auto/', 'webm') .
                "' type='video/webm'>" .
                '</video>',
            VideoTag::fromParams('movie', [
    ...
    public function testUploadTag()
    {
        ...
        self::assertMatchesRegularExpression(
            $pattern,
            (string) UploadTag::fromParams('image')
        );
        ...
        self::assertMatchesRegularExpression(
            $pattern,
            (string) UploadTag::fromParams('image', ['chunk_size' => 5000000])
        );

        $pattern =
            "/<input class='cloudinary-fileupload classy' " .
            "data-cloudinary-field='image' " .
            "data-form-data='{\&quot;timestamp\&quot;:\d+,\&quot;signature\&quot;:\&quot;\w+\&quot;," .
            "\&quot;api_key\&quot;:\&quot;a\&quot;}' " .
            "data-max-chunk-size='\d+' " .
    ...
    private static function commonImageTagFromParamsHelper(
        ...
        if (!empty($srcsetBreakpoints)) {
            $single_srcset_image = static function ($w) use (
                $customTransStr,
                $publicId
            ) {
                return self::DEFAULT_UPLOAD_PATH .
                    "{$customTransStr}/c_scale,w_{$w}/{$publicId} {$w}w";
            };
            $attributes['srcset'] = implode(
                ', ',
                array_map($single_srcset_image, $srcsetBreakpoints)
            );
        }
