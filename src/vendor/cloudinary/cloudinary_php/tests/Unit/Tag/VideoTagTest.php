...
final class VideoTagTest extends TagTestCase
{
    ...
    public function testVideoTag()
    {
        ...
        self::assertEquals((string) $expected, (string) $tag);
    ...
    {
        $video = (new Video(self::VIDEO_NAME))
            ->rotate(Rotate::byAngle(17))
            ->resize(Scale::scale(500));
        $tag = new VideoTag($video, []);

        $expectedPoster =
            'https://res.cloudinary.com/test123/video/upload/a_17/c_scale,w_500/sample.jpg';
    ...
    public function testVideoTagAssetConfigurationBuilders()
    {
        ...
        $customPosterAttr = str_replace(
            self::CLOUD_NAME,
            self::CUSTOM_CLOUD_NAME,
            $this->posterAttr
        );
        $expected =
            "<video src=\"{$this->video->cloudName(
                self::CUSTOM_CLOUD_NAME
            )}\" $customPosterAttr>" . '</video>';
        self::assertEquals(
            $expected,
    ...
    public function testVideoTagWithAttributes()
    {
        ...
        $expected =
            "<video autoplay controls loop muted=\"true\" style=\"border: 1px\" src=\"{$this->video}\" " .
            "$this->posterAttr>" .
            '</video>';
