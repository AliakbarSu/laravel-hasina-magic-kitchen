...
final class AnalyticsTest extends AssetTestCase
{
    ...
    {
        self::assertEquals('BAAJ1uAI', MockAnalytics::sdkAnalyticsSignature());
    }
    ...
    public function testTechVersion()
    {
        ...
        self::assertEquals('BAAJ1uAM', MockAnalytics::sdkAnalyticsSignature());
        ...
        self::assertEquals('BAAJ1uM', MockAnalytics::sdkAnalyticsSignature());
    }
    ...
    public function testSdkAnalyticsSignatureWithIntegration()
    {
        ...
        self::assertEquals('BBBAACH9', MockAnalytics::sdkAnalyticsSignature());
    }
}
