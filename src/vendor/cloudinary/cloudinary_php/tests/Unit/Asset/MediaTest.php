...
final class MediaTest extends AssetTestCase
{
    ...
    {
        self::assertImageUrl(self::IMAGE_NAME, $this->media);

        self::assertImageUrl(self::IMAGE_NAME, $this->media->toUrl());
    }
    ...
    public function testMediaMultipleTypes()
    {
        self::assertImageUrl(
            ...
            $this->media
                ->fill(80, 160, Gravity::auto())
                ->transcode(AudioCodec::vorbis())
        );
    }
}
