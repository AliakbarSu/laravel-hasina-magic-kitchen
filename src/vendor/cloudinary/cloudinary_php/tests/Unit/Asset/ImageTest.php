...
final class ImageTest extends AssetTestCase
{
    ...
    {
        self::assertImageUrl(self::IMAGE_NAME, $this->image);

        self::assertImageUrl(self::IMAGE_NAME, $this->image->toUrl());
    }
    ...
    public function testSuffixForNotSupportedDeliveryType()
    {
        ...
        self::assertObjectLoggedMessage(
            $this->image,
    ...
    public function testFetchImage()
    {
        ...
        self::assertImageUrl(self::FETCH_IMAGE_URL, $image, [
    ...
    public function testFacebookImage()
    {
        ...
        self::assertImageUrl(self::FACEBOOK_ID, $image, [
    ...
    public function testVideoThumbnailImages()
    {
        ...
        self::assertImageUrl(self::YOUTUBE_ID, $image, [
            'delivery_type' => DeliveryType::YOUTUBE,
        ]);

        $image = Image::vimeo(self::VIMEO_ID);

        self::assertImageUrl(self::VIMEO_ID, $image, [
            'delivery_type' => DeliveryType::VIMEO,
        ]);
    }
    ...
    public function testSpriteImage()
    {
        ...
        self::assertImageUrl(self::SPRITE_TAG . '.css', $image, [
            'delivery_type' => DeliveryType::SPRITE,
        ]);
    }
    ...
    public function testImage()
    {
        $this->image
            ->resize(
                Pad::limitPad(170, 180)
                    ->background(
                        Background::predominantGradient(2)->palette(
                            'cyan',
                            'magenta',
                            'yellow',
                            'black'
        ...
        $elseTransStr =
            'c_fit,h_202,w_102/c_scale,fl_ignore_aspect_ratio,w_202';
        ...
        self::assertImageUrl(
            "{$t_str}/l_" .
                self::IMAGE_NAME .
                "/fl_layer_apply/{$expectedExpression}/" .
                self::IMAGE_NAME,
            $this->image
        );
    }
    ...
    {
        self::assertImageUrl(
            'e_cartoonify/r_max/co_lightblue,e_outline:100/b_lightblue/c_scale,h_300/eo_3,so_1/' .
                self::IMAGE_NAME,
