...
final class MediaFromParamsTest extends AssetTestCase
{
    ...
    {
        self::assertMediaFromParamsUrl(self::IMAGE_NAME);
    }
    ...
    public function testCloudNameOptions()
    {
        ...
        self::assertMediaFromParamsUrl(self::IMAGE_NAME, $options, $options);
    }
    ...
    public function testSecureDistribution()
    {
        ...
        self::assertMediaFromParamsUrl(self::IMAGE_NAME, $options, [
    ...
    public function testSecureSubdomainTrue()
    {
        ...
        self::assertMediaFromParamsUrl(self::IMAGE_NAME, $options, [
            'hostname' =>
                self::CLOUD_NAME . '-res-2.' . UrlConfig::DEFAULT_DOMAIN,
            'cloud_name' => '',
            'protocol' => self::PROTOCOL_HTTPS,
        ]);
    }
    ...
    public function testFormat()
    {
        ...
        self::assertMediaFromParamsUrl(self::ASSET_ID, $options, [
            'suffix' => '.' . self::IMG_EXT,
        ]);
    }
    ...
    public function testIgnoreHttp()
    {
        ...
        self::assertMediaFromParamsUrl('http://blah.com/hello', $options, [
    ...
    public function testFetch()
    {
        ...
        self::assertMediaFromParamsUrl('http://blah.com/hello?a=b', $options, [
            'delivery_type' => DeliveryType::FETCH,
    ...
    public function testFetchWithFormat()
    {
        ...
        self::assertMediaFromParamsUrl(self::FETCH_IMAGE_URL, $options, [
            'delivery_type' => DeliveryType::FETCH,
    ...
    public function testForceVersion()
    {
        ...
        self::assertMediaFromParamsUrl(self::IMAGE_IN_FOLDER, [
            'force_version' => false,
        ]);
    ...
    public function testShorten()
    {
        ...
        $options = [
            'shorten' => true,
            'type' => DeliveryType::PRIVATE_DELIVERY,
        ];
    ...
    public function testMediaSignedUrl($options, $expectedPath)
    {
        ...
        self::assertMediaFromParamsUrl($publicIdToSign, $options, [
            'path' => $expectedPath,
    ...
    public function testFileSignedUrl($options, $expectedPath)
    {
        ...
        self::assertFileFromParamsUrl($publicIdToSign, $options, [
            'path' => $expectedPath,
            'delivery_type' => $deliveryType,
        ]);
    }
    ...
    {
        self::assertErrorThrowing(function () {
            $options = [
                'url_suffix' => self::URL_SUFFIX,
                'private_cdn' => true,
                'type' => DeliveryType::FACEBOOK,
            ];
    ...
    public function testDontSignTheUrlSuffix()
    {
        ...
        $expectedSignature = self::invokeNonPublicMethod(
            $referenceImage,
            'finalizeSimpleSignature'
        );
        ...
        self::assertMediaFromParamsUrl(self::IMAGE_NAME, $options, [
            ...
            'cloud_name' => '',
            'full_path' =>
                "images/$expectedSignature/" .
                self::URL_SUFFIXED_ASSET_ID .
                '.' .
                self::IMG_EXT_JPG,
        ]);
        ...
        $expectedTransformedSignature = self::invokeNonPublicMethod(
            $referenceTImage,
            'finalizeSimpleSignature'
        );
        ...
        self::assertMediaFromParamsUrl(self::IMAGE_NAME, $options, [
            ...
            'cloud_name' => '',
            'full_path' =>
                "images/$expectedTransformedSignature/a_0/" .
                self::URL_SUFFIXED_ASSET_ID .
                '.' .
                self::IMG_EXT_JPG,
        ]);
    ...
    public function testUrlSuffixForVideos()
    {
        ...
        self::assertMediaFromParamsUrl(self::VIDEO_NAME, $options, [
            'hostname' => self::PRIVATE_CDN_HOSTNAME,
            'cloud_name' => '',
            'full_path' =>
                'videos/' . self::URL_SUFFIXED_ASSET_ID . '.' . self::VID_EXT,
        ]);
    }
    ...
    public function testUrlSuffixForAuthenticated()
    {
        ...
        self::assertMediaFromParamsUrl(self::IMAGE_NAME, $options, [
            ...
            'cloud_name' => '',
            'full_path' =>
                'authenticated_images/' . self::URL_SUFFIXED_IMAGE_NAME,
        ]);
    }
}
