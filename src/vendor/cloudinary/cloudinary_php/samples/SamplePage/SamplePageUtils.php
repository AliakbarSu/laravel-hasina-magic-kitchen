...
function getFormattedUrl($url, $transformation)
{
    ...
    return '<span class="url-start">' .
        $urlStart .
        '</span>' .
        '<span class="url-folders">' .
        $urlFolders .
        '</span>' .
        '<span class="url-transformation">' .
        $transformation .
        '</span>' .
        '<span class="url-end">' .
        $urlEnd .
    ...
    return '
        ...
        '</title>
                ...
                <link rel="shortcut icon"
                      href="' .
        Image::fetch('https://cloudinary.com/favicon.png')->format(
            Format::ico()
        ) .
        '"/>
            </head>
...
{
    $result =
        '<ul class="nav nav-tabs h-100 bg-light" style="border-bottom:0">';
