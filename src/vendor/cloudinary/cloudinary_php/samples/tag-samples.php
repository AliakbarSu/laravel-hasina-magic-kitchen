...
$imageTagGroup = [
    ...
    'items' => [
        [
            'name' => 'Upload',
            'items' => [
                [new ImageTag($testImage), 'new ImageTag(\'$testImage\')'],
            ],
        ],
        [
            'name' => 'Fetch',
        ...
        [
            ...
            'items' => [
                [
                    new PictureTag('sample', [
                        [
                            'max_width' => 360,
                            'transformation' => 'ar_9:16,c_fill,g_auto,w_360',
                        ],
                        [
                            'min_width' => 360,
                            'max_width' => 800,
...
$videoTagGroup = [
    ...
    'items' => [
        [
            'name' => 'Video Tag',
            'items' => [[new VideoTag('dog'), 'new VideoTag(\'dog\')']],
        ],
        [
            'name' => 'Transformation',
            'items' => [
...
$variousTagsGroup = [
    ...
    'items' => [
        [
            'name' => 'Upload Tag',
            'items' => [[new UploadTag('image'), 'new UploadTag(\'image\')']],
        ],
        [
