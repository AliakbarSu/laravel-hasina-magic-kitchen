...
$imageGroup = [
    ...
    'items' => [
        ...
        [
            ...
            'items' => [
                ...
                [
                    (new Transformation())->resize(
                        Crop::thumbnail(200, 200, Gravity::auto())
                    ),
                    '(new Transformation())->resize(Crop::thumbnail(200, 200, Gravity::auto()))',
                ],
                [
                    (new Transformation())->resize(
                        Crop::thumbnail(200, 200)->position(10, 10)
                    ),
    ...
    Gravity::auto(FocalGravity::BODY)
                ...
                [
                    (new Transformation())->resize(
                        Crop::thumbnail(200, 200)->gravity(Gravity::north())
                    ),
                ...
                [
                    (new Transformation())->resize(
                        Crop::thumbnail(200, 200)->gravity(
                            Gravity::face(CompassGravity::center())
                        )
                    ),
                    ' (new Transformation())->resize(
                ...
                [
                    (new Transformation())->resize(
                        Crop::thumbnail(200, 200, Gravity::auto())->zoom(0.7)
                    ),
        ...
        [
            ...
            'items' => [
                [
                    (new Transformation())->resize(
                        Pad::pad(200, 200)->background(Color::CORAL)
                    ),
                ...
                [
                    (new Transformation())->resize(
                        Pad::pad(200, 200)->background(
                            AutoBackground::border()->contrast()
                        )
                    ),
                    ' (new Transformation())->resize(
    ...
    Effect::shadow()->offset(10, PVar::height()->divide()->numeric(50))->color(Color::green())
                ...
                [
                    (new Transformation())->effect(
                        Effect::outline(OutlineMode::OUTER, 15, 200)->color(
                            Color::orange()
                        )
                    ),
                    '(new Transformation())->effect(
    Effect::outline(OutlineMode::OUTER, 15, 200)->color(Color::orange())
                ...
                [
                    (new Transformation())->effect(
                        Effect::generic('outline:outer', 15, 200)->addQualifier(
            ...
            'items' => [
                ...
                [
                    (new Transformation())->overlay(
                        Source::image('logo')->resize(Scale::scale(200, 200))
                    ),
                    '(new Transformation())->overlay(Source::image(\'logo\')->resize(Scale::scale(200, 200)))',
                ],
                [
                    (new Transformation())->overlay(
                        Source::image('logo')->resize(
                            Fill::fill(200, 200, Gravity::auto())
                        ),
...
$videoGroup = [
    ...
    'items' => [
        [
            ...
            'items' => [
                ...
                [
                    (new Transformation())->trim(
                        VideoEdit::trim('10p')->duration('30p')
                    ),
    ...
    ->concatenate(
        ...
        [
            ...
            'items' => [
                [
                    (new Transformation())->transcode(
                        VideoCodec::h264(
                            VideoCodecProfile::BASELINE,
                            VideoCodecLevel::VCL_31
                        )
                    ),
                    '(new Transformation())
...
function createSampleGroup($group)
{
    foreach ($group['items'] as &$subGroup) {
        if (!isset($subGroup['publicId'])) {
            $subGroup['publicId'] = isset($group['publicId'])
                ? $group['publicId']
                : 'sample';
        }
        ...
        foreach ($subGroup['items'] as &$sampleArray) {
            ...
            $sampleArray = ClassUtils::verifyVarArgsInstance(
                $sampleArray,
