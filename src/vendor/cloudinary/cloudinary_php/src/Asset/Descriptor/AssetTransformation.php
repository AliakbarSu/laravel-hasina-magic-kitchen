...
class AssetTransformation implements ComponentInterface
{
    ...
    {
        $this->transformation = ClassUtils::forceInstance(
            $transformation,
    ...
    {
        return new self(
            Transformation::fromParams($params),
    ...
    public function importJson($json)
    {
        ...
        if (
            !array_key_exists('asset_transformation', $json) ||
            !array_key_exists('transformation', $json['asset_transformation'])
        ) {
            throw new InvalidArgumentException(
                'Invalid asset transformation JSON'
            );
        }
    ...
    public function jsonSerialize($includeEmptyKeys = false)
    {
        $dataArr = [
            'transformation' => $this->transformation
                ? (string) $this->transformation
                : null, // FIXME: serialization
