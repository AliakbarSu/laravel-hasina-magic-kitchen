 ...
 * @api
 */
abstract class BaseMediaAsset extends BaseAsset implements
    CommonTransformationInterface
{
    ...
    public function toUrl($withTransformation = null, $append = true)
    {
        return $this->finalizeUrl(
            ArrayUtils::implodeUrl(
                $this->prepareUrlParts($withTransformation, $append)
            )
        );
    }
    ...
    {
        if (
            ArrayUtils::get($params, DeliveryType::KEY) !== DeliveryType::FETCH
        ) {
            return $params;
        }
