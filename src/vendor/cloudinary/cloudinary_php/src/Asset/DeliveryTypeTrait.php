...
trait DeliveryTypeTrait
{
    ...
    {
        return self::deliveryTypeBuilder(
            $publicId,
            $configuration,
            DeliveryType::UPLOAD
        );
    ...
    {
        $image = self::deliveryTypeBuilder(
            $tag,
            $configuration,
            DeliveryType::SPRITE
        );
