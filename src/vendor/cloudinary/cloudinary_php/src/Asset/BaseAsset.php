...
abstract class BaseAsset implements AssetInterface
{
    ...
    public static function fromParams($source, $params = [])
    {
        ArrayUtils::setDefaultValue(
            $params,
            'resource_type',
            static::getAssetType(static::class)
        );
    ...
    public function importJson($json)
    {
        try {
            ...
            $this->getLogger()->critical('Error importing JSON', [
    ...
    public function toUrl()
    {
        return $this->finalizeUrl(
            ArrayUtils::implodeUrl($this->prepareUrlParts())
        );
    }
    ...
    public function jsonSerialize(
        ...
        foreach ([$this->cloud, $this->urlConfig] as $confSection) {
            $section = $confSection->jsonSerialize(
                false,
                $includeEmptyKeys,
