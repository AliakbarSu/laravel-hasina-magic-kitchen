...
class ProvisioningConfiguration
{
    ...
    public function init($config = null)
    {
        ...
        if ($config === null) {
            $config =
                (string) getenv(self::CLOUDINARY_ACCOUNT_URL_ENV_VAR) ?: null;
        }
        ...
        if (ProvisioningConfigUtils::isAccountUrl($config)) {
            ...
            throw new ConfigurationException(
                'Invalid account configuration, please set up your environment'
            );
        }
    }
    ...
    {
        $this->importJson(
            ProvisioningConfigUtils::parseAccountUrl($accountUrl)
        );
    ...
    public function jsonSerialize(
        ...
        foreach ($this->sections as $section) {
            ...
            $section = $this->$section->jsonSerialize(
                $includeSensitive,
                $includeEmptyKeys
            );
