...
trait UploadTrait
{
    ...
    public static function buildUploadParams($options)
    {
        ...
        $complexParams = [
            ...
            'allowed_formats' => ApiUtils::serializeSimpleApiParam(
                ArrayUtils::get($options, 'allowed_formats')
            ),
        ...
        return ApiUtils::finalizeUploadApiParams(
            array_merge(
                ArrayUtils::whitelist($options, $simpleParams),
                $complexParams
            )
        );
    }
    ...
    public function uploadAsync($file, $options = [])
    {
        ...
        $endPoint = self::getUploadApiEndPoint(
            UploadEndPoint::UPLOAD,
            $options
        );

        return $this->apiClient->postFileAsync(
            $endPoint,
            $file,
            $params,
            $options
    ...
    {
        return $this->unsignedUploadAsync(
            $file,
            $uploadPreset,
            $options
        )->wait();
