...
trait ArchiveTrait
{
    ...
    public static function buildArchiveParams($options)
    {
        ...
        foreach ($arrayParams as $arrayParam) {
            $arrayParamValues[$arrayParam] = ArrayUtils::build(
                ArrayUtils::get($options, $arrayParam)
            );
        }
    ...
    public function createArchiveAsync($options = [], $targetFormat = null)
    {
        ...
        return $this->callUploadApiAsync(
            UploadEndPoint::GENERATE_ARCHIVE,
            $params,
            $options
        );
    }
    ...
    public function downloadFolder($folderPath, $options = [])
    {
        ...
        $options[AssetType::KEY] = ArrayUtils::get(
            $options,
            AssetType::KEY,
            AssetType::ALL
        );
    ...
    public function downloadBackedupAsset($assetId, $versionId)
    {
        ...
        return $this->getUploadUrl(
            null,
            UploadEndPoint::DOWNLOAD_BACKUP,
            $params
        );
    }
}
