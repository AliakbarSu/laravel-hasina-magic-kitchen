...
class SearchApi implements JsonSerializable
{
    ...
    {
        return $this->apiClient->postJsonAsync(
    ...
    public function asArray()
    {
        return ArrayUtils::mapAssoc(
            static function ($key, $value) {
                return in_array($key, self::KEYS_WITH_UNIQUE_VALUES)
                    ? array_values($value)
                    : $value;
            },
            array_filter($this->query, static function ($value) {
