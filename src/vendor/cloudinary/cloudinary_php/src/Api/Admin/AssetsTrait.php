...
trait AssetsTrait
{
    ...
    public function assets($options = [])
    {
        ...
        ArrayUtils::appendNonEmpty(
            $uri,
            ArrayUtils::get($options, DeliveryType::KEY)
        );
    ...
    public function update($publicId, $options = [])
    {
        ...
        $primitiveOptions = ArrayUtils::whitelist($options, [
        ...
        $arrayOptions = [
            'tags' => ApiUtils::serializeSimpleApiParam(
                ArrayUtils::get($options, 'tags')
            ),
            'context' => ApiUtils::serializeContext(
                ArrayUtils::get($options, 'context')
            ),
            'metadata' => ApiUtils::serializeContext(
                ArrayUtils::get($options, 'metadata')
            ),
            'face_coordinates' => ApiUtils::serializeArrayOfArrays(
                ArrayUtils::get($options, 'face_coordinates')
            ),
            'custom_coordinates' => ApiUtils::serializeArrayOfArrays(
                ArrayUtils::get($options, 'custom_coordinates')
            ),
            'access_control' => ApiUtils::serializeJson(
                ArrayUtils::get($options, 'access_control')
            ),
        ];
     ...
     * @throws ApiError
     */
    public function deleteDerivedByTransformation(
        $publicIds,
        $transformations = [],
        $options = []
    ) {
        ...
        $params['transformations'] = ApiUtils::serializeAssetTransformations(
            $transformations
        );
        $params = array_merge(
            $params,
            ArrayUtils::whitelist($options, ['invalidate'])
        );
     ...
     * @return ApiResponse
     */
    public function deleteRelatedAssets(
        $publicId,
        $assetsToUnrelate,
        $options = []
    ) {
    ...
    {
        $filtered = ArrayUtils::whitelist($options, [
            'keep_original',
            'next_cursor',
            'invalidate',
        ]);
        if (isset($options['transformations'])) {
            $filtered[
                'transformations'
            ] = ApiUtils::serializeAssetTransformations(
    ...
    {
        return ArrayUtils::whitelist($options, [
            'exif',
            'colors',
            'faces',
            'quality_analysis',
