...
trait FocalGravityBuilderTrait
{
    ...
    {
        return self::createWithFocalGravity(
            FocalGravity::ADVANCED_FACE,
            ...$fallback
        );
    }
    ...
    {
        return self::createWithFocalGravity(
            FocalGravity::CUSTOM_NO_OVERRIDE,
            ...$fallback
        );
    }
