...
abstract class SourceBasedEffectAction extends EffectAction
{
    ...
    {
        $this->source = ClassUtils::verifyInstance(
            $source,
            BaseSource::class,
            ImageSource::class
        );
    ...
    {
        $this->position = ClassUtils::verifyInstance(
            $position,
            BasePosition::class,
    ...
    {
        $sourceQualifiers = $this->source
            ? $this->source->getStringQualifiers()
            : [];
        $sourceTransformation = $this->source
            ? $this->source->getTransformation()
            : null;
        $positionQualifiers = $this->position
            ? $this->position->getStringQualifiers()
            : [];
        ...
        return [
            ...
            'additional' => ArrayUtils::mergeNonEmpty(
                $positionQualifiers,
