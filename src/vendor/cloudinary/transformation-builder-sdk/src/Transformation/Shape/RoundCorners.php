...
class RoundCorners extends BaseAction
{
    ...
    {
        parent::__construct(
            ClassUtils::verifyVarArgsInstance($qualifiers, CornerRadius::class)
        );
    }
    ...
    public function setRadius(...$values)
    {
        return $this->addQualifier(
            ClassUtils::verifyVarArgsInstance($values, CornerRadius::class)
        );
    }
    ...
    {
        $this->qualifiers[CornerRadius::getName()]->setSimpleValue(
            $name,
            $value
        );
