...
class Concatenate extends VideoOverlay
{
    ...
    {
        $this->source->addTransformation(
            ClassUtils::verifyInstance($source, Transition::class)
        );
    ...
    {
        $this->source->addQualifier(
            ClassUtils::verifyInstance($duration, Duration::class)
        );
