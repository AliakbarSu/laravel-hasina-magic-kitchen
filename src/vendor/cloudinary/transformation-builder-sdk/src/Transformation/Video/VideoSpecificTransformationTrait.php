...
trait VideoSpecificTransformationTrait
{
    ...
    public function roundCorners($radius)
    {
        return $this->addAction(
            ClassUtils::verifyInstance($radius, RoundCorners::class)
        );
    }
    ...
    {
        return $this->addAction(
            ClassUtils::verifyInstance($videoSource, Concatenate::class)
        );
    }
    ...
    {
        return $this->addAction(
            ClassUtils::verifyInstance($min, Fps::class, null, $max)
        );
    }
    ...
    {
        return $this->addAction(
            ClassUtils::verifyInstance($interval, KeyframeInterval::class)
        );
    }
    ...
    {
        return $this->addAction(
            ClassUtils::verifyInstance($bitRate, BitRate::class, null, $type)
        );
    }
    ...
    {
        return $this->addAction(
            ClassUtils::verifyInstance($value, VideoSampling::class)
        );
    }
