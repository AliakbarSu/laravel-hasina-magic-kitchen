...
class UVal extends Expression
{
    ...
    {
        return self::uVal(
            StringUtils::ensureWrappedWith($value, self::STRING_MARKER)
        );
    }
    ...
    {
        $publicId = StringUtils::ensureWrappedWith(
            $publicId,
            self::STRING_MARKER
        );
    ...
    {
        $contextKey = StringUtils::ensureWrappedWith(
            $contextKey,
            self::STRING_MARKER
        );
    ...
    {
        $metadataKey = StringUtils::ensureWrappedWith(
            $metadataKey,
            self::STRING_MARKER
        );
