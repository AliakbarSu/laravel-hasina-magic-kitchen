...
trait ImageSpecificTransformationTrait
{
    ...
    {
        $underlay = ClassUtils::forceInstance(
            $layer,
            ImageOverlay::class,
            null,
            $position,
    ...
    public function roundCorners(
        ...
        $qualifiers = ArrayUtils::safeFilter([
            $radiusOrTopLeft,
            $topRight,
            $bottomRight,
            $bottomLeft,
        ...
        $roundCorners = ClassUtils::verifyVarArgsInstance(
            $qualifiers,
            RoundCorners::class
        );
    ...
    {
        return $this->addAction(
            ClassUtils::verifyInstance($color, Background::class)
        );
    }
    ...
    {
        return $this->addAction(
            ClassUtils::verifyInstance($background, Background::class)
        );
    }
    ...
    {
        return $this->addAction(
            ClassUtils::verifyInstance($colorSpace, ColorSpace::class)
        );
    }
    ...
    {
        return $this->addAction(
            ClassUtils::verifyInstance($prefix, Prefix::class)
        );
    }
    ...
    {
        return $this->addAction(
            ClassUtils::verifyInstance($animated, AnimatedEdit::class)
        );
    }
}
