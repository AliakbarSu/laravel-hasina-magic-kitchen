...
trait ImageSourceTrait
{
    ...
    public static function image($publicId)
    {
        return static::createWithSource(
            ClassUtils::verifyInstance($publicId, ImageSource::class)
        );
    }
    ...
    {
        return static::createWithSource(
            ClassUtils::verifyInstance($fetchUrl, FetchImageSource::class)
        );
    }
    ...
    {
        return static::createWithSource(
            ClassUtils::verifyInstance($lutId, LutLayer::class)
        );
    }
