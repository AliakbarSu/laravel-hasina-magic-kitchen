...
trait CommonTransformationTrait
{
    ...
    {
        return $this->addAction(
            ClassUtils::verifyInstance($flag, FlagQualifier::class)
        );
    }
    ...
    {
        return $this->addAction(
            ClassUtils::verifyInstance($name, Variable::class, null, $value)
        );
    }
    ...
    {
        return $this->addAction(
            ClassUtils::verifyInstance($angle, Rotate::class)
        );
    }
