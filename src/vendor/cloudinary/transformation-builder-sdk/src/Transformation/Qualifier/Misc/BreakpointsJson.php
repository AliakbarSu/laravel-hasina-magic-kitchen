...
class BreakpointsJson extends BaseQualifier
{
    ...
    {
        $this->minWidth =
            $minWidth ?: ResponsiveBreakpointsConfig::DEFAULT_MIN_WIDTH;
    ...
    {
        $this->maxWidth =
            $maxWidth ?: ResponsiveBreakpointsConfig::DEFAULT_MAX_WIDTH;
    ...
    {
        $this->maxImages =
            $maxImages ?: ResponsiveBreakpointsConfig::DEFAULT_MAX_IMAGES;
    ...
    public function __toString()
    {
        return self::getKey() .
            '_auto:breakpoints_' .
            "{$this->minWidth}_{$this->maxWidth}_" .
            TransformationUtils::bytesToKB($this->bytesStep) .
            "_{$this->maxImages}:json";
    }
