...
class QualifierMultiValue extends BaseComponent
{
        ...
        if (static::MIN_ARGUMENTS > count($arguments)) {
            throw new InvalidArgumentException(
                'Qualifier "' .
                    static::getName() .
                    '" must have at least ' .
                    static::MIN_ARGUMENTS .
                    ' arguments(s)'
            );
        }

        if (
            static::MAX_ARGUMENTS !== 0 &&
            count($arguments) > static::MAX_ARGUMENTS
        ) {
            throw new InvalidArgumentException(
                'Qualifier "' .
                    static::getName() .
    ...
    {
        return $this->setSimpleNamedValue(
    ...
    public function __toString()
    {
        ...
        return ArrayUtils::implodeFiltered(static::VALUE_DELIMITER, [
            $values,
            $namedValues,
        ]);
    }
