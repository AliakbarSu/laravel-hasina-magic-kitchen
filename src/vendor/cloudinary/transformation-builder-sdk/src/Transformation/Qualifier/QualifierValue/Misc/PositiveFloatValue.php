    ...
    public function setArguments(...$arguments)
    {
        if (count($arguments) > 1) {
            throw new InvalidArgumentException(
                'No more than 1 argument is expected'
            );
        }
        ...
        if (!is_numeric($floatValue)) {
            if (
                !(
                    is_object($floatValue) &&
                    method_exists($floatValue, '__toString')
                )
            ) {
                throw new InvalidArgumentException(
                    'Argument should be a number or a string'
                );
            }
            throw new InvalidArgumentException(
                "'$floatValue' should be a number or a string"
            );
        }
        if ($floatValue < 0) {
            throw new InvalidArgumentException(
                "'$floatValue' should be greater than zero"
            );
        }
