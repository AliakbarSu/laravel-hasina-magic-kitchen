...
trait ImageAdjustmentTrait
{
    ...
    {
        return EffectAction::withBlend(
            Adjust::AUTO_BRIGHTNESS,
            EffectRange::PERCENT,
            $blend
        );
    }
    ...
    {
        return EffectAction::withStrength(
            Adjust::VIBRANCE,
    ...
    {
        return EffectAction::withLevel(
            Adjust::BRIGHTNESS_HSB,
            EffectRange::BRIGHTNESS,
            $level
        );
    }
    ...
    {
        return EffectAction::fromEffectQualifier(
            new RecolorQualifier(...$colorMatrix)
        );
    }
    ...
    {
        return EffectAction::withLevel(
            Adjust::OPACITY_THRESHOLD,
            EffectRange::POSITIVE_PERCENT,
            $level
        );
    }
