...
trait LightroomEffectTrait
{
    ...
    {
        return $this->addLightroomFilter(
            LightroomEffect::VIGNETTE_AMOUNT,
            $value,
            EffectRange::DEFAULT_RANGE
        );
    }
    ...
    {
        return $this->addLightroomFilter(
            LightroomEffect::SHARPNESS,
            $value,
            LightroomEffect::SHARPNESS_RANGE
        );
    }
    ...
    {
        return $this->addLightroomFilter(
            LightroomEffect::COLOR_NOISE_REDUCTION,
            $value,
            EffectRange::PERCENT
        );
    }
    ...
    {
        return $this->addLightroomFilter(
            LightroomEffect::NOISE_REDUCTION,
            $value,
            EffectRange::PERCENT
        );
    }
    ...
    {
        return $this->addLightroomFilter(
            LightroomEffect::SHARPEN_DETAIL,
            $value,
            EffectRange::PERCENT
        );
    }
    ...
    {
        return $this->addLightroomFilter(
            LightroomEffect::EXPOSURE,
            $value,
            LightroomEffect::EXPOSURE_RANGE
        );
    }
