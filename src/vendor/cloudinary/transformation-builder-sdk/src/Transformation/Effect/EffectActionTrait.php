...
trait EffectActionTrait
{
    ...
    {
        return static::fromEffectQualifier(
            new EffectQualifier($name, ...$args)
        );
    }
    ...
    {
        return static::fromEffectQualifier(
            new ValueEffectQualifier($effectName, $value, ...$args)
        );
    }
    ...
    {
        return static::fromEffectQualifier(
            new LimitedEffectQualifier($effectName, $range, $value, ...$args)
        );
    }
     ...
     */
    public static function withLevel(
        $effectName,
        $range,
        $value = null,
        ...$args
    ) {
        return new LevelEffectAction(
            new LevelEffectQualifier($effectName, $range, $value, ...$args)
        );
    }
    ...
    public static function withStrength(
        ...
        return new StrengthEffectAction(
            new StrengthEffectQualifier($effectName, $range, $value, ...$args)
        );
    }
     ...
     */
    public static function withBlend(
        $effectName,
        $range,
        $value = null,
        ...$args
    ) {
        return new BlendEffectAction(
            new BlendEffectQualifier($effectName, $range, $value, ...$args)
        );
    }
    ...
    public static function withThreshold(
        ...
        return new ThresholdEffectAction(
            new ThresholdEffectQualifier($effectName, $range, $value, ...$args)
        );
    }
    ...
    {
        return new DurationEffectAction(
            new DurationEffectQualifier($effectName, $value, ...$args)
        );
    }
    ...
    {
        return new ToleranceEffectAction(
            new ToleranceEffectQualifier($effectName, $value, ...$args)
        );
    }
    ...
    public static function fromParams(array $qualifiers)
    {
        ...
        return static::fromEffectQualifier(
            new EffectQualifier($effectName, ...$qualifiers)
        );
    }
