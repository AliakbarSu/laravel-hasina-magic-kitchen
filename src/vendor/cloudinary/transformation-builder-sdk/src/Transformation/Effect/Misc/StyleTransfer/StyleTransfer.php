...
class StyleTransfer extends SourceBasedEffectAction
{
    ...
    public function __construct(
        ...
        parent::__construct(
            new StyleTransferQualifier($strength, $preserveColor)
        );
    ...
    {
        $this->qualifiers[StyleTransferQualifier::getName()]->preserveColor(
            $preserveColor
        );
    ...
    {
        $this->qualifiers[StyleTransferQualifier::getName()]->strength(
            $strength
        );
