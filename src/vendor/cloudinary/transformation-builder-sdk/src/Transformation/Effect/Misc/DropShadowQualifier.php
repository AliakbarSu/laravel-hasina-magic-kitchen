...
class DropShadowQualifier extends EffectQualifier
{
    ...
    public function __construct(
        ...
        $this->value->setSimpleValue(
            'properties',
            new ListExpressionQualifierMultiValue()
        );
    ...
    {
        $this->value
            ->getSimpleValue('properties')
            ->setSimpleNamedValue('azimuth', $azimuth);
    ...
    public function elevation($elevation)
    {
        $this->value
            ->getSimpleValue('properties')
            ->setSimpleNamedValue('elevation', $elevation);
    ...
    public function spread($spread)
    {
        $this->value
            ->getSimpleValue('properties')
            ->setSimpleNamedValue('spread', $spread);
