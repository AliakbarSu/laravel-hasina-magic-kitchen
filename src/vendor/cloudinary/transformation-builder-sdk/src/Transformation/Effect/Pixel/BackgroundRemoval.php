...
class BackgroundRemoval extends EffectAction
{
    ...
    {
        parent::__construct(
            new ListEffectQualifier(PixelEffect::BACKGROUND_REMOVAL)
        );
    ...
    public function fineEdges($fineEdges = true)
    {
        ...
        $this->getMainQualifier()
            ->getPropertiesValue()
            ->setSimpleNamedValue(self::FINE_EDGES, $value);
    ...
    public function hints(...$foregroundObjects)
    {
        $this->getMainQualifier()
            ...
            ->setSimpleNamedValue(
                self::HINTS,
                new FullListExpressionQualifierMultiValue(...$foregroundObjects)
            );
