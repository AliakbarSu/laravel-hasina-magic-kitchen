...
final class TransformationTest extends TransformationTestCase
{
    public function testTransformation()
    {
        ...
        $t->resize(
            Scale::scale(Qualifier::width(100), 200)
        ...
        $t_expected =
            'b_blue,c_lpad,g_south_west,h_18,w_17/e_replace_color:green:17:red/' .
            'c_scale,fl_attachment:file%252Ebin,fl_ignore_aspect_ratio,h_200,w_100/e_sepia:100';
        self::assertEquals($t_expected, (string) $t);
        ...
        $t2->resize(
            Crop::thumbnail(
                100,
                200,
                Gravity::auto(FocalGravity::ADVANCED_EYES)
            )
        )
        ...
        $t2_expected =
            'c_thumb,g_auto:adv_eyes,h_200,w_100/e_hue:99/e_replace_color:pink:50:cyan';

        self::assertEquals($t2_expected, (string) $t2);
        self::assertEquals($t2_expected, (new Transformation())->toUrl($t2));
    ...
    {
        self::assertEquals('dpr_2.0', (string) Delivery::dpr(2.0));
    }
    ...
    public function testTransformationGeneric()
    {
        ...
        self::assertEquals('c_scale,h_200,w_100', (string) $t);
        self::assertEquals(
            'c_scale,h_200,w_100/c_crop,w_10',
            (string) $tGeneric
        );
        self::assertEquals('transformation', $tGenericJson['name']);
        self::assertInstanceOf(
            Transformation::class,
            $tGenericJson['actions'][0]
        );
        self::assertInstanceOf(Crop::class, $tGenericJson['actions'][1]);
    }
    ...
    public function testTransformationResize()
    {
        ...
        self::assertEquals('c_scale,h_200,w_100/dpr_2.5', (string) $t);
        ...
        self::assertEquals('c_jackie,h_175,w_50', (string) $t);
    }
    ...
    public function testTransformationExpressions()
    {
        ...
        $t->conditional(
            Conditional::ifCondition('width > 997', Adjust::red(99))->otherwise(
                Adjust::green(99)
            )
        );
    ...
    public function testTransformationFormat()
    {
        ...
        self::assertEquals('f_flif', (string) $t);

        $t->format(Format::auto());

        self::assertEquals('f_flif/f_auto', (string) $t);
    }
    ...
    public function testTransformationQuality()
    {
        ...
        $t->quality(
            (new Quality(99))->chromaSubSampling(ChromaSubSampling::chroma444())
        );

        self::assertEquals('q_99:444', (string) $t);

        $t->quality(
            Quality::autoLow()->chromaSubSampling(
                ChromaSubSampling::chroma420()
            )
        );

        self::assertEquals('q_99:444/q_auto:low:420', (string) $t);
    }
    ...
    public function testTransformationShape()
    {
        ...
        self::assertEquals('r_17:18:19:20', (string) $t);

        $t->roundCorners(RoundCorners::max());

        self::assertEquals('r_17:18:19:20/r_max', (string) $t);

        $t->rotate(17);

        self::assertEquals('r_17:18:19:20/r_max/a_17', (string) $t);
    }
    ...
    public function testTransformationAddAction()
    {
        ...
        self::assertEquals($genericAction, (string) $t);

        $t->addAction(
            Action::generic($genericAction)->addQualifier(
                RoundCorners::byRadius(17)
            )
        );

        self::assertEquals("$genericAction/$genericAction,r_17", (string) $t);
    ...
    public function testImageTransformationLayers()
    {
        self::assertEquals(
            ...
            (string) (new ImageTransformation())->adjust(
    ...
    public function testSetFlags()
    {
        self::assertEquals(
            ...
            (string) (new Transformation())->addAction(
                Action::generic()
    ...
    public function testSetFlagsWithBuilders()
    {
        ...
        self::assertEquals(
            ...
            (string) (new Transformation())
                ...
                ->keepAttribution()
                ->keepIptc()
                ->addFlag(Qualifier::flag(Flag::STRIP_PROFILE))
        );
    }
    ...
    public function testDefaultImage()
    {
        self::assertEquals(
            'd_avatar',
            (string) (new Transformation())->delivery(
                Delivery::defaultImage('avatar')
            )
        );
    }
    ...
    public function testTiffWithIgnoreMaskChannels()
    {
        self::assertEquals(
            ...
            (string) (new Transformation())->delivery(
                Delivery::format(Format::tiff())->ignoreMaskChannels()
            )
        );
    }
    ...
    public function testColorSpace()
    {
        ...
        self::assertEquals(
            'cs_icc:public_id',
            (string) (new Transformation())->colorSpace(
                ColorSpace::icc('public_id')
            )
        );
    }
    ...
    {
        self::assertEquals('dl_20', (string) (new Transformation())->delay(20));
    }
    ...
    {
        self::assertStrEquals('dn_20', (new Transformation())->density(20));
    }
    ...
    public function testPage()
    {
        ...
        self::assertEquals(
            'pg_2',
            (string) (new Transformation())->extract(
        ...
        self::assertEquals(
            'pg_3;5-7;9-',
            (string) (new Transformation())->extract(
                Extract::getPage(3, '5-7')->byRange(9)
            )
        );
    ...
    {
        self::assertEquals('pg_2', (string) (new Transformation())->extract(2));
    ...
    public function testPsdTools()
    {
        ...
        self::assertEquals(
            'pg_2;3;4;5',
            (string) (new Transformation())->psdTools(
                PsdTools::getLayer(2, 3, 4, 5)
            )
        );
        ...
        self::assertEquals(
            ...
            (string) (new Transformation())->psdTools(
                PsdTools::getLayer()->byNames('record_cover', 'Shadow')
            )
        );
        ...
        self::assertEquals(
            ...
            (string) (new Transformation())->psdTools(
                PsdTools::getLayer()->byName('record_cover', 1)
            )
        );
    ...
    public function testClippingPath()
    {
        ...
        self::assertEquals(
            ...
            (string) (new Transformation())->psdTools(
                PsdTools::clip('name:myClippingPath')
            )
        );
        ...
        self::assertEquals(
            'fl_clip,pg_name:myClippingPath',
            (string) (new Transformation())->psdTools(
                PsdTools::clip()->byName('myClippingPath')
            )
        );
    ...
    public function testSmartObject()
    {
        ...
        self::assertEquals(
            'pg_embedded:2',
            (string) (new Transformation())->psdTools(
                PsdTools::smartObject()->byIndex(2)
            )
        );
        ...
        self::assertEquals(
            ...
            (string) (new Transformation())->psdTools(
                PsdTools::smartObject()->byLayerName('record_cover')
            )
        );
        self::assertEquals(
            'pg_embedded:name:record_cover;Shadow',
            (string) (new Transformation())->psdTools(
                PsdTools::smartObject()->byLayerNames('record_cover', 'Shadow')
            )
        );
    }
            ...
            (new Transformation())
                ...
                ->overlay(
                    Overlay::source(
                        Source::text(
                            'Love',
                            (new TextStyle('Cookie', 40))->fontWeight(
                                FontWeight::bold()
                            )
                        )->transformation(
                            (new ImageTransformation())
                                ->effect(
                                    Effect::colorize()->color(Color::rgb('F08'))
                                )
