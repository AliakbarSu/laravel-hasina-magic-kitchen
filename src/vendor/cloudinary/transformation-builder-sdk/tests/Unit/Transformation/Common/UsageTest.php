 ...
 * Class UsageTest
 */
final class UsageTest extends TransformationTestCase
{
    ...
    public function testCrop()
    {
        ...
        self::assertEquals(
            ...
            (string) (new Transformation())->resize(
                Crop::thumbnail(80, 80, Gravity::auto())
            )
        );
        ...
        self::assertEquals(
            ...
            (string) (new Transformation())->resize(
                Crop::thumbnail(80, 80)->position(10, 10)
            )
        );
        ...
        self::assertEquals(
            ...
            (string) (new Transformation())->resize(
                Crop::thumbnail(80, 80)->gravity(
                    Gravity::auto(FocalGravity::BODY)->add('clown')
                )
            )
        );
        ...
        self::assertEquals(
            ...
            (string) (new Transformation())->resize(
                Crop::thumbnail(80, 80)->gravity(CompassGravity::north())
            )
        );
        ...
        self::assertEquals(
            ...
            (string) (new Transformation())->resize(
                Crop::thumbnail(80, 80, Gravity::face(Compass::CENTER))
            )
        );
        ...
        self::assertEquals(
            ...
            (string) (new Transformation())->resize(
                Crop::thumbnail(80, 80, Gravity::auto())->zoom(0.7)
            )
        );
        ...
        self::assertEquals(
            ...
            (string) (new Transformation())->resize(
                Crop::thumbnail(80, 80)->gravity('up')
            ) // not real gravity
        );
    }
    ...
    public function objectGravityDataProvider()
    {
        ...
        foreach ($classes as $class) {
            ...
            $constants = array_merge(
                $gravities,
                array_values($reflectionClass->getConstants())
            );
            $gravities = $constants;
        }
    ...
    public function testObjectGravityMethods($value, $method)
    {
        self::assertEquals(
            ...
            (string) (new Transformation())->resize(
                Crop::thumbnail(8, 5, Gravity::object()->{$method}())
            )
        );
        self::assertEquals(
            "c_thumb,g_$value,h_80,w_80",
            (string) (new Transformation())->resize(
                Crop::thumbnail(80, 80, FocusOn::{$method}())
            )
        );
    }
    ...
    public function testObjectGravity()
    {
        self::assertEquals(
            ...
            (string) (new Transformation())->resize(
                Crop::thumbnail(80, 80)->gravity(
                    Gravity::auto(ObjectGravity::BOWL)->add('cup')
                )
            )
        );
        ...
        self::assertEquals(
            'c_thumb,h_80,w_80',
            (string) (new Transformation())->resize(
                Crop::thumbnail(80, 80)->gravity(Gravity::object())
            )
        );
        ...
        self::assertEquals(
            ...
            (string) (new Transformation())->resize(
                Crop::thumbnail(80, 80, Gravity::object(ObjectGravity::CAT))
            )
        );
        ...
        self::assertEquals(
            ...
            (string) (new Transformation())->resize(
                Crop::thumbnail(
                    80,
                    80,
                    Gravity::focusOn(FocusOn::person(), FocusOn::kitchen())
                )
            )
        );
    ...
    public function testCustomFunction()
    {
        ...
        $remoteSource =
            'https://df34ra4a.execute-api.us-west-2.amazonaws.com/default/cloudinaryFn';
        $encodedRemoteSource = StringUtils::base64UrlEncode($remoteSource);
        $params = [
            'function_type' => CustomFunction::WASM,
            'source' => $wasmSource,
        ];

        self::assertEquals(
            "fn_wasm:$wasmSource",
            (string) (new Transformation())->customFunction(
                CustomFunction::wasm($wasmSource)
            )
        );
        ...
        self::assertEquals(
            ...
            (string) (new Transformation())->customFunction(
                CustomFunction::remote($remoteSource)
            )
        );
        ...
        self::assertEquals(
            ...
            (string) (new Transformation())->customFunction(
                CustomFunction::remote($remoteSource)->preprocess()
            )
        );
        ...
        self::assertEquals(
            ...
            (string) (new Transformation())->customFunction(
                CustomFunction::fromParams($params, true)
            )
        );
        ...
        self::assertEquals(
            ...
            (string) (new Transformation())->customFunction(
                CustomFunction::fromParams($encodedRemoteSource)
            )
        );

        self::assertEquals(
            "fn_wasm:$wasmSource",
            (string) Qualifier::customFunction(
                $wasmSource,
                CustomFunction::WASM
            )
        );
    ...
    public function testPad()
    {
        self::assertEquals(
            ...
            (string) (new Transformation())->resize(
                Pad::pad(80, 80)->background(Color::GREEN)
            )
        );
        ...
        self::assertEquals(
            ...
            (string) (new Transformation())->resize(
                Pad::pad(80, 80)->background(Background::border()->contrast())
            )
        );
    ...
    public function testEffects()
    {
        self::assertEquals(
            ...
            (string) (new Transformation())->effect(
                Effect::generic('kuku', 11, 'some_param')
            )
        );
        ...
        self::assertEquals(
            ...
            (string) (new Transformation())->adjust(
                Adjust::tint(100, Color::GREEN, Color::RED)
            )
        );
        ...
        self::assertEquals(
            ...
            (string) (new Transformation())->adjust(
                Adjust::replaceColor(Color::MAROON, 80, '2b38aa')
            )
        );
        ...
        self::assertEquals(
            'e_replace_color:maroon:80:2b38aa',
            (string) (new Transformation())->adjust(
                Adjust::replaceColor(Color::MAROON, 80, Color::rgb('2b38aa'))
            )
        );
    ...
    public function testQuality()
    {
        ...
        self::assertEquals(
            ...
            (string) (new Transformation())->quality(
                Quality::level(70)->chromaSubSampling(
        ...
        self::assertEquals(
            'q_70:qmax_80',
            (string) (new Transformation())->quality(
                Quality::level(70)->quantization(80)
            )
        );
    ...
    public function testNamedTransformation()
    {
        self::assertEquals(
            't_my_transformation',
            (string) (new Transformation())->namedTransformation(
                'my_transformation'
            )
        );
    }
    ...
    public function testLayers()
    {
        ...
        self::assertEquals(
            ...
            (string) (new Transformation())->underlay(
                ImageSource::image('blabla')
            )
        );
        ...
        self::assertEquals(
            ...
            (string) (new Transformation())->overlay(
                ImageSource::image('blabla')->resize(Scale::scale(80, 80))
            )
        );
        ...
        self::assertEquals(
            ...
            (string) (new Transformation())->overlay(
                (new ImageSource('blabla'))->resize(
                    Fill::fill(80, 80, Gravity::auto())
                ),
    ...
    public function testPage()
    {
        ...
        self::assertEquals(
            ...
            (string) (new Transformation())->psdTools(
                PsdTools::getLayer()
                    ->byNames('record_cover', 'Shadow')
                    ->byName('record_cover2')
                    ->byName('Shadow2')
            )
        );
    }
    ...
    public function testExpressions()
    {
        self::assertEquals(
            ...
            (string) (new Transformation())->conditional(
                Conditional::ifCondition(
                    ...
                    (new Transformation())->overlay(
                        Source::text(
                            'this is big',
                            new TextStyle(FontFamily::ARIAL, 50)
    ...
    public function testVideo()
    {
        self::assertEquals(
            'eo_10,so_6.5',
            (string) (new VideoTransformation())->trim(
                Timeline::position(6.5, 10)
            )
        );
        ...
        self::assertEquals(
            'du_30p,so_10p',
            (string) (new VideoTransformation())->trim(
                Timeline::position('10p')->duration('30p')
            )
        );
        ...
        self::assertEquals(
            ...
            (string) (new VideoTransformation())->transcode(
                VideoCodec::h264(
        ...
        self::assertEquals(
            ...
            (string) (new VideoTransformation())->addSubtitles(
                'sample_sub_en.srt'
            )
        );
    }
