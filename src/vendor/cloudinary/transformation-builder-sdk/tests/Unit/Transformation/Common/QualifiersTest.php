...
final class QualifiersTest extends TestCase
{
    ...
    {
        self::assertEquals($color, (string) Color::{$color}());
        self::assertEquals($color, (string) ColorValue::{$color}());
    }

    public function testColorByValue()
    {
        self::assertEquals('#ff9900', (string) Color::rgb('#ff9900'));

        self::assertEquals(
            'rgb:ff11aa',
            (string) (new ColorValue('#000000'))->color(
                Qualifier::color('#ff11aa')
            )
        );
    ...
    public function testGenericArgument()
    {
        ...
        self::assertEquals('name_value1|value2', (string) $genericArgument);
    }
    ...
    public function testGenericNamedArgument()
    {
        ...
        self::assertEquals('name!value1|value2', (string) $genericArgument);
    }
    ...
    public function testSetNamedValue()
    {
        self::assertEquals(
            ...
            (string) (new Text())->setNamedValue(
                new TextStyle(FontFamily::PARISIENNE, 35)
            )
        );
        self::assertEquals(
            'h_100_text_style_Parisienne',
            (string) (new Text())->setNamedValues(
                new TextStyle(FontFamily::PARISIENNE),
                Height::fromValue(100)
            )
        );
    }
}
