...
final class EffectTest extends TransformationTestCase
{
    ...
    {
        self::assertEquals('e_sepia', (string) Effect::sepia());
        ...
        self::assertEquals('e_grayscale', (string) Effect::grayscale());

        self::assertEquals('e_negate', (string) Effect::negate());
        ...
        self::assertEquals(
            ...
            (string) Effect::simulateColorBlind(
                SimulateColorBlind::rodMonochromacy()
            )
        );
    }
    ...
    {
        self::assertEquals('e_colorize', (string) Effect::colorize());
        self::assertEquals('e_colorize:17', (string) Effect::colorize(17));
    ...
    {
        self::assertEquals('e_pixelate', (string) Effect::pixelate());

        self::assertEquals('e_pixelate:5', (string) Effect::pixelate(5));
        ...
        self::assertEquals(
            ...
            (string) Effect::pixelate(17)->region(
                Region::custom(10, 20, 30, 40)
            )
        );
    ...
    {
        self::assertEquals('e_blur:17', (string) Effect::blur(17));

        self::assertEquals('e_blur:17', (string) Effect::blur()->strength(17));

        self::assertEquals(
            'e_blur_region:2000,h_40,w_30,x_10,y_20',
            (string) Effect::blur(2000)->region(
                Region::custom()
                    ->size('30x40')
                    ->position(10, 20)
            )
    ...
    {
        self::assertEquals('e_vignette:17', (string) PixelEffect::vignette(17));
        ...
        self::assertEquals(
            ...
            (string) PixelEffect::makeTransparent()
                ->tolerance(17)
        ...
        self::assertEquals(
            ...
            (string) PixelEffect::removeBackground()
                ->colorToRemove(Color::rgb('#aabbcc'))
                ->screen()
        );

        self::assertEquals(
            'e_bgremoval:red',
            (string) PixelEffect::removeBackground()->colorToRemove(
                Color::red()
            )
        );
    }
    ...
    {
        self::assertStrEquals('e_dropshadow', Effect::dropShadow());
    ...
    public function testCutOutImageEffect()
    {
        self::assertEquals(
            ...
            (string) Effect::cutOut('logo')->position(
                Position::south()->offsetY(20)
            )
        );
    }
    ...
    {
        self::assertEquals('e_gradient_fade', (string) Effect::gradientFade());
    ...
    {
        self::assertEquals('e_shear:30:0', (string) Reshape::shear(30, 0));

        self::assertEquals('e_shear:30:60', (string) Reshape::shear(30, 60));
    ...
    public function testCartoonify()
    {
        ...
        self::assertEquals(
            'e_cartoonify:17:19',
            (string) Effect::cartoonify()
                ->lineStrength(17)
                ->colorReductionLevel(19)
        );
    ...
    {
        self::assertEquals('e_adv_redeye', (string) Effect::advancedRedEye());

        self::assertEquals('e_redeye', (string) Effect::redEye());
        ...
        self::assertEquals('e_vectorize', (string) Effect::vectorize());
    ...
    {
        self::assertEquals('e_loop', (string) Effect::loop());

        self::assertEquals('e_loop:17', (string) Effect::loop(17));
        ...
        self::assertEquals('e_boomerang', (string) Effect::boomerang());

        self::assertEquals('e_reverse', (string) Effect::reverse());
    }
    ...
    public function testLightroomFilters()
    {
        self::assertEquals(
            ...
            (string) Effect::lightroom()
                ->blacks(50)
                ->exposure(3.5)
                ->genericFilter('generic', 17)
        );

        self::assertEquals(
            'e_lightroom:whitebalance_fluorescent',
            (string) Effect::lightroom()->whiteBalance(
        ...
        self::assertEquals(
            ...
            (string) Effect::lightroom()->xmp(
                Xmp::source('my_presets/warm_shadow.xmp')->authenticated()
            )
        );
    }
    ...
    public function testGenericEffects()
    {
        self::assertEquals(
            ...
            (string) Effect::generic('outline:outer', 15, 200)->addQualifier(
                Qualifier::generic('co', 'orange')
            )
        );
        ...
        self::assertEquals('e_sepia', (string) Effect::fromParams('sepia'));
    }
