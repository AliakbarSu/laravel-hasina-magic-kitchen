 ...
 */
final class TransformationVariableTest extends TransformationTestCase
{
    ...
    public function testTransformationVariables()
    {
        $expected =
            'c_thumb,g_' .
            self::$stringVariableStr .
            ',h_' .
            self::$integerExpression2Str .
            ',w_' .
            self::$integerExpression1Str .
            ',x_' .
            self::$integerVariable1Str .
            ',y_' .
        ...
        $th->width(self::$integerExpression1Raw)->height(
            self::$integerExpression2Raw
        );
     ...
     */
    private function assertComponentEquals(
        $expectedStr,
        $component,
        $messages = ''
    ) {
