...
final class AdjustTest extends TestCase
{
    ...
    {
        self::assertEquals('e_hue:17', (string) Adjust::hue(17));

        self::assertEquals('e_hue:17', (string) Adjust::hue()->level(17));
    ...
    {
        self::assertEquals('e_gamma:50', (string) Adjust::gamma(50));

        self::assertEquals('e_gamma:50', (string) Adjust::gamma()->level(50));

        self::assertEquals('e_improve', (string) Adjust::improve());
        ...
        self::assertEquals('e_improve:17', (string) new Improve(17));

        self::assertEquals('e_improve:outdoor', (string) Improve::outdoor());

        self::assertEquals('e_improve:indoor', (string) Improve::indoor());
        ...
        self::assertEquals('e_auto_color:17', (string) Adjust::autoColor(17));
        ...
        self::assertEquals('e_vibrance:17', (string) Adjust::vibrance(17));
        ...
        self::assertEquals('e_viesus_correct', (string) new ViesusCorrect());
    ...
    {
        self::assertEquals('e_fill_light', (string) Adjust::fillLight());

        self::assertEquals('e_fill_light:70', (string) Adjust::fillLight(70));
    ...
    {
        self::assertEquals('o_100', (string) Adjust::opacity(100));
    ...
    {
        self::assertEquals('e_sharpen:17', (string) Adjust::sharpen(17));
    ...
    public function testGenericAdjustments()
    {
        self::assertEquals(
            ...
            (string) Adjust::generic('make_cool', 17, 19)->setFlag(
                Flag::animated()
            )
        );
    }
