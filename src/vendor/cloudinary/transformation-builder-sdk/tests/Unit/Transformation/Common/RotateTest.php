...
final class RotateTest extends TestCase
{
    ...
    {
        self::assertEquals('a_17', (string) Rotate::byAngle(17));
        ...
        self::assertEquals('a_hflip', (string) Rotate::horizontalFlip());
        ...
        self::assertEquals('a_90', (string) Rotate::byAngle(Degree::deg90()));

        $rotate = Rotate::byAngle(Degree::deg90())
            ->setFlag(LayerFlag::splice())
            ->setFlag(LayerFlag::relative());

        self::assertEquals('a_90,fl_relative,fl_splice', (string) $rotate);

        $rotate->unsetFlag(LayerFlag::splice());

        self::assertEquals('a_90,fl_relative', (string) $rotate);
    }
    ...
    public function testAngle()
    {
        ...
        self::assertEquals('a_5', (string) $angle);

        $angle->setAngle(6);

        self::assertEquals('a_6', (string) $angle);
    }
    ...
    {
        self::assertEquals("a_$mode", (string) Angle::{$method}());
    }
}
