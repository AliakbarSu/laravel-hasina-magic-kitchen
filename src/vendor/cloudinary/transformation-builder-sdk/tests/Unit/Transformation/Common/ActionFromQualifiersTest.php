...
final class ActionFromQualifiersTest extends TransformationTestCase
{
    ...
    const CUSTOM_FUNCTION_WASM_ARRAY = [
        'function_type' => 'wasm',
        'source' => 'blur.wasm',
    ];
    ...
    const CUSTOM_FUNCTION_REMOTE_STR = 'remote:aHR0cHM6Ly9kZjM0cmE0YS5leGVjdXRlLWFwaS51cy13ZXN0LTIuYW1hem9uYXdzLmNvbS9kZWZhdWx0L2Nsb3VkaW5hcnlGbg==';
    ...
    {
        return [
            'Keyframe interval as a positive integer' => [
                'ki_10.0',
                ['keyframe_interval' => 10],
            ],
            'Keyframe interval as a big positive integer' => [
                'ki_300.0',
                ['keyframe_interval' => 300],
            ],
            'Keyframe interval as a float with a zero integer' => [
                'ki_0.05',
                ['keyframe_interval' => 0.05],
            ],
            'Keyframe interval as a float' => [
                'ki_3.45',
                ['keyframe_interval' => 3.45],
            ],
            'Keyframe interval as a string' => [
                'ki_10',
                ['keyframe_interval' => '10'],
            ],
            'Keyframe interval as a user variable' => [
                'ki_$ki',
    ...
    {
        return [
            'Video sampling as an integer' => [
                'vs_20',
                ['video_sampling' => 20],
            ],
            'Video sampling as a float' => [
                'vs_2.3s',
                ['video_sampling' => '2.3s'],
            ],
        ];
    ...
    public function startOffsetDataProvider()
    {
        return [
            ...
            'Start offset as a string' => [
                'so_2.64',
                ['start_offset' => '2.64'],
            ],
            'Start offset as a string with a percent as a letter' => [
                'so_35p',
                ['start_offset' => '35p'],
            ],
            'Start offset as a string with a % sign' => [
                'so_36p',
                ['start_offset' => '36%'],
            ],
    ...
    public function endOffsetDataProvider()
    {
        return [
            ...
            'End offset as a string with a percent as a letter' => [
                'eo_35p',
                ['end_offset' => '35p'],
            ],
            'End offset as a string with a % sign' => [
                'eo_36p',
                ['end_offset' => '36%'],
            ],
        ];
    ...
    {
        return [
            'Duration parameter as a float' => [
                'du_2.63',
                ['duration' => 2.63],
            ],
            'Duration parameter as a string' => [
                'du_2.64',
                ['duration' => '2.64'],
            ],
            'Duration parameter as a string with a percent as a letter' => [
                'du_35p',
                ['duration' => '35p'],
            ],
            'Duration parameter as a string with a % sign' => [
                'du_36p',
                ['duration' => '36%'],
            ],
        ];
    ...
    public function operatorsDataProvider()
    {
        return [
            ...
            'Should support and translate operators: <, > and variables: effect, aspect_ratio' => [
                ...
                [
                    'if' => 'aspect_ratio > 0.3 && aspect_ratio < 0.5',
                    'effect' => 'grayscale',
                ],
            ],
            ...
            ' and variables: width, height, pages, faces, aspect_ratio' => [
                ...
                [
                    'if' =>
                        'width = 0 && height != 0 || aspect_ratio < 0 && page_count > 0 and face_count <= 0 ' .
                        'and width >= 0',
                    'effect' => 'grayscale',
                ],
            ],
    ...
    public function radiusDataProvider()
    {
        return [
            ...
            'Radius as an array' => ['r_10:20:30', ['radius' => [10, 20, 30]]],
    ...
    {
        return [
            'Should support a named transformation' => [
                't_blip',
                ['transformation' => 'blip'],
            ],
    ...
    public function generalQualifiersActionDataProvider()
    {
        return [
            ...
            'Should support underlay' => ['u_text', ['underlay' => 'text']],
            'Should support fps' => ['fps_22', ['fps' => 22]],
            ...
            'Should support a page' => ['pg_5', ['page' => 5]],
            ...
            'Should support density' => ['dn_150', ['density' => 150]],
    ...
    public function testQualifiersAction($transformation, $options)
    {
        self::assertEquals(
            $transformation,
            (string) new QualifiersAction($options)
        );
    }
    ...
    public function layersQualifiersDataProvider()
    {
        return [
            ...
            'private' => [
                ['public_id' => 'logo', 'type' => 'private'],
                'private:logo',
            ],
            'format' => [
                ['public_id' => 'logo', 'format' => 'png'],
                'logo.png',
            ],
            'video' => [
                ['resource_type' => 'video', 'public_id' => 'cat'],
                'video:cat',
            ],
            'text' => [
                [
            ...
            'fetch' => [
                [
                    'public_id' => 'logo',
                    'fetch' => 'https://cloudinary.com/images/old_logo.png',
                ],
            ...
            'image name' => [self::IMAGE_NAME, self::IMAGE_NAME],
        ];
    }
    ...
    public function testLayerQualifierFactory($qualifiers, $expected)
    {
        self::assertEquals(
            "l_$expected",
            (string) LayerQualifierFactory::fromParams($qualifiers)
        );
    }
     ...
     */
    public function testLayerQualifierFactoryExpectException(
        $layerQualifiers,
        $exceptionMessage
    ) {
