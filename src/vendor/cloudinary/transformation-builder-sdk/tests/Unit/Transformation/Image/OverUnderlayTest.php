...
final class OverUnderlayTest extends TestCase
{
    public function testOverUnderlayLayer()
    {
        ...
        $focalPosition = new FocalPosition(
            Gravity::auto(FocalGravity::ADVANCED_FACES)
        );

        $textLayer = ImageSource::text(
            'Hello world',
            new TextStyle(FontFamily::ARIAL, 14)
        );
    ...
    public function testOverlayBlendMode()
    {
        ...
        self::assertEquals(
            ...
            (string) Overlay::source('test')->blendMode(
                BlendMode::antiRemoval()
            )
        );
    }
