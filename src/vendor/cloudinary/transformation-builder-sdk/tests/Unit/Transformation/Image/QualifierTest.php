...
final class QualifierTest extends TestCase
{
    public function testGravity()
    {
        ...
        self::assertEquals('', (string) $no_gravity);

        self::assertEquals('g_west', (string) CompassGravity::west());
    }
    ...
    public function testAutoGravity()
    {
        ...
        self::assertEquals('g_auto', (string) $autoGravity);
        $autoFaces = Gravity::auto(FocalGravity::FACES);

        self::assertEquals('g_auto:faces', (string) $autoFaces);

        $adv_faces = Gravity::auto(FocalGravity::ADVANCED_FACES);

        self::assertEquals('g_auto:adv_faces', (string) $adv_faces);
    }
    ...
    {
        self::assertEquals('b_red', (string) Background::color(Color::RED));
    }
    ...
    public function testAutoBackground()
    {
        self::assertEquals(
            ...
            (string) Background::predominantGradient(
                2,
        ...
        self::assertEquals(
            ...
            (string) Background::predominantGradient(2)->palette(
    ...
    {
        self::assertEquals('c_scale', (string) new CropMode('scale'));
    }
    ...
    public function testGenericAction()
    {
        ...
        self::assertEquals(
            ...
            (string) Action::generic($genericAction)->addQualifier(
                RoundCorners::max()->addQualifier(Rotate::autoLeft())
            )
        );
    }
}
