...
final class ResizeTest extends TestCase
{
    public function testScale()
    {
        ...
        self::assertEquals('c_scale', (string) $scale);
        //        self::assertEquals(
        ...
        self::assertEquals('c_scale,h_200,w_100', (string) $scaleWithParams);
        ...
        $scaleWithBuiltParams = Scale::scale()
            ->width(100)
            ->height(200)
            ->aspectRatio(0.5);
        ...
        self::assertEquals('c_limit', (string) $limitFit);
        ...
        $fit = Scale::fit();
        self::assertEquals('c_fit', (string) $fit);
        ...
        self::assertEquals('c_mfit', (string) Scale::minimumFit());
    }
    ...
    public function testPad()
    {
        ...
        self::assertEquals('c_pad', (string) $pad);
        ...
        self::assertEquals('c_mpad,h_200,w_100', (string) $padWithParams);
        ...
        $padWithBuiltParams = Pad::pad(100, 200)
            ->offset(50, 100)
    ...
    {
        $fillPad = FillPad::fillPad(100, 200)
            ->background(Color::RED)
            ->offsetY(20);
    ...
    public function testImagga()
    {
        ...
        self::assertEquals('c_imagga_crop,h_200,w_100', (string) $imaggaCrop);

        $imaggaScale = Resize::imaggaScale(100, 200);

        self::assertEquals('c_imagga_scale,h_200,w_100', (string) $imaggaScale);
    }
    ...
    public function testFill()
    {
        ...
        self::assertEquals('c_fill,g_auto,h_200,w_100', (string) $fill);
        ...
        self::assertEquals('c_lfill,g_auto,h_200,w_100', (string) $limitFill);
    }

    public function testCrop()
    {
        $crop = Crop::crop(100, 200)
            ->x(10)
            ->y(20);

        self::assertEquals('c_crop,h_200,w_100,x_10,y_20', (string) $crop);

        $thumb = Crop::thumbnail(100, 200, Gravity::auto())->zoom(0.5);

        self::assertEquals('c_thumb,g_auto,h_200,w_100,z_0.5', (string) $thumb);
    }
    ...
    public function testResize()
    {
        ...
        self::assertEquals(
            ...
            (string) Resize::generic('custom', 100, 200)
                ->addQualifier(Qualifier::generic('cu', 'v1', 17))
                ->offsetX(10)
                ->offsetY(20)
        );
        ...
        self::assertEquals(
            ...
            (string) Resize::crop(100, 200)->resizeMode(
        ...
        self::assertEquals(
            ...
            (string) Resize::crop(100, 200)->gravity(
                Gravity::auto(AutoGravity::object(Gravity::ocrText())->avoid())
            )
        );
        ...
        self::assertEquals(
            ...
            (string) Resize::crop(100, 200)->gravity(
                Gravity::auto(
                    AutoGravity::object(Gravity::ocrText())->weight(30)
                )
            )
        );
