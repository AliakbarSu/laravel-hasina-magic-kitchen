...
final class QualityTest extends TestCase
{
    ...
    {
        $qp = (new QualityQualifier(17))->chromaSubSampling(
    ...
    {
        $q = (new Quality(17))->chromaSubSampling(
            ChromaSubSampling::chroma420()
        );
    ...
    public function testAutoQuality()
    {
        ...
        $aqec = Quality::autoEco()->chromaSubSampling(
        ...
        self::assertEquals(
            'q_auto:best',
            (string) Delivery::quality(Quality::autoBest())
        );
    }
