...
final class StringUtilsTest extends TestCase
{
    ...
    {
        $expectedEscaped =
            '\L\o\r\e\m ipsu\m d\ol\o\r sit a\m\et, c\ons\ect\etu\r adipiscing \elit';
        self::assertEquals(
            $expectedEscaped,
    ...
    {
        self::assertEquals('', StringUtils::toAcronym(''));

        self::assertEquals('t', StringUtils::toAcronym('test'));

        self::assertEquals('ta', StringUtils::toAcronym('test_acronym'));
