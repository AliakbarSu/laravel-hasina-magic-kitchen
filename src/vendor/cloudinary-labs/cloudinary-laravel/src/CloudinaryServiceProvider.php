...
class CloudinaryServiceProvider extends ServiceProvider
{
    ...
    protected function bootMacros()
    {
        ...
        UploadedFile::macro('storeOnCloudinaryAs', function (
            $folder = null,
            $publicId = null
        ) {
            return resolve(CloudinaryEngine::class)->uploadFile(
    ...
    {
        Blade::component(
            'cloudinary::components.button',
            $this->getComponentName('cld-upload-button')
        );
        Blade::component(
            'cloudinary::components.image',
            $this->getComponentName('cld-image')
        );
        Blade::component(
            'cloudinary::components.video',
            $this->getComponentName('cld-video')
        );
    }
    ...
    {
        $this->app['config']['filesystems.disks.cloudinary'] = [
            'driver' => 'cloudinary',
        ];
