...
import { A as ApplicationLogo } from "./ApplicationLogo-b5012507.js";
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "hidden space-x-8 sm:-my-px sm:ml-10 sm:flex", children: [
            ...
            /* @__PURE__ */ jsx(
              NavLink,
              {
                href: route("admin.addDish"),
                active: route().current("admin.addDish"),
                children: "Add Dish"
              }
            ),
            /* @__PURE__ */ jsx(
              NavLink,
              {
                href: route("admin.addMenu"),
                active: route().current("admin.addMenu"),
                children: "Add Menu"
              }
            )
          ] })
